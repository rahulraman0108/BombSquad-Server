...
values = {
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('Рэдагаваць\n'
                    'Саўндтрэк'),
        'fetchingITunesText':'атрымліванне плэйліста iTunes...',
    ...
    'gatherWindow':{
        ...
        'friendPromoCodeInstructionsText':('Каб скарыстацца ім, зайдзіце ў "Налады -> Дадатковыя -> Увесці прома-код" у ${APP_NAME}.\n'
                                           'Спасылкі на гульню для ўсіх АС, якія падтрымліваюцца, вы можаце знайсці на bombsquadgame.com.'),
        ...
        'friendPromoCodeWhereToEnterText':'(у "Налады -> Дадатковыя -> Увесці Прома-Код")',
        ...
        'wifiDirectDescriptionTopText':('Wi-Fi Direct можа выкарыстоўвацца для злучэння Android прылад непасрэдна,\n'
                                        ...
                                        '\n'
                                        'Каб cкарыстацца гэтым, адчыніце налады і знайдзіце \'Wi-Fi Direct\'.'),
    ...
    'internal':{
        ...
        'hasMenuControlText':'${NAME} зараз кантралюе меню.',
        ...
        'joinedPartyInstructionsText':('Сябр далучыўся да вашага лоббі.\n'
    ...
    'playerDelayedJoinText':'${PLAYER} увойдзе ў пачатку наступнай гульні.',
    ...
    'promoSubmitErrorText':'Памылка пры адпраўцы прома-кода; праверце інтэрнэт-злучэнне',
    ...
    'settingsWindowAdvanced':{
        ...
        'enterPromoCodeText':'Увесці Прома-Код',
    ...
    'showText':'Паказаць',
    'signInForPromoCodeText':'Вы павінны ўвайсці, каб карыстацца прома-кодамі.',
    ...
    'storeText':'Крама',
    'submittingPromoCodeText':'Адпраўка Прома-Кода...',
        ...
        'tips':{
            ...
            ('If your device gets too warm or you\'d like to conserve battery power,\n'
             'turn down "Visuals" or "Resolution" in Settings->Graphics'):('Калi ваша прылада награваецца цi вы жадаеце захаваць запад батарэi,\n'
                                                                           'паменьшыце "Вiзуальныя эфекты" цi "Разрашэнне" ý Налады->Графiка.'),
    ...
    'usingItunesText':'Выкарыстоўванне iTunes для саўндтрэкаў...',
