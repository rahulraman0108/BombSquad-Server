...
values = {
    'accountSettingsWindow':{
        'accountNameRules':'Emoji atau karakter spesial tidak bisa dimasukan untuk nama akun',
        'accountProfileText':'(profil akun)',
        'accountsText':'Akun',
        'achievementProgressText':'Penghargaan: ${COUNT} dari ${TOTAL}',
        'campaignProgressText':'Progres Petualangan [Sulit]: ${PROGRESS}',
        'changeOncePerSeason':'Anda hanya bisa mengganti ini sekali per musim.',
        'changeOncePerSeasonError':'Anda harus menunggu sampai musim selanjutnya untuk menggantinya lagi (${NUM} hari)',
        'customName':'Nama Khusus',
        'linkAccountsEnterCodeText':'Masukkan kode',
        'linkAccountsGenerateCodeText':'Buat Kode',
        'linkAccountsInfoText':'(bagikan progres permainan dengan platform lain)',
        'linkAccountsInstructionsNewText':('untuk menghubungkan dua akun,buat kode pada \n'
                                           'media pertama dan masaukan kode itu pada media kedua.\n'
                                           'Data darikedua akun akan di bagi kedua media.\n'
                                           '(Data dari akun pertama akan hilang)\n'
                                           '\n'
                                           'Kamu bisa menghubungkan ke ${COUNT} akun.\n'
                                           '\n'
                                           'PENTING:menghubungkan akun hanya bekerja untuk akunmu sendiri;\n'
                                           'Jika kamu menghubungkan dengan akun temanmu kamu tidak akan\n'
                                           'bisa bermain online pada waktu yang bersamaan.'),
        ...
        'nameChangeConfirm':'Ganti nama anda menjadi ${NAME}?',
        'resetProgressConfirmNoAchievementsText':('Tindakan ini akan mengatur ulang progres co-op dan\n'
                                                  'skor tertinggi anda (kecuali tiket).\n'
                                                  'Tidak dapat dibatalkan. Apakah anda yakin?'),
        'resetProgressConfirmText':('Ini akan mengatur ulang progres co-op,\n'
                                    'pencapaian, dan skor tertinggi anda\n'
                                    '(kecuali tiket). Ini tidak dapat\n'
                                    'dibatalkan. Anda yakin?'),
        'resetProgressText':'Atur Ulang Progres',
        'setAccountName':'Pasang Nama Akun',
        'setAccountNameDesc':('Pilih nama yang ditampilkan untuk akun anda.\n'
                              'Gunakan nama dari akun yang tersambung atau\n'
                              'buatlah nama khusus baru.'),
        'signInInfoText':('Masuk untuk mendapatkan tiket, bermain online,\n'
                          'dan menyambungkan progres antar device.'),
        'signInText':'Masuk',
        ...
        'signInWithGameCircleText':'Masuk dengan Game Circle',
        ...
        'signInWithTestAccountText':'Sign in menggunakan akun test',
        'signOutText':'Keluar',
        ...
        'youAreSignedInAsText':'Anda terdaftar sebagai:'
    },
    'achievementChallengesText':'Tantangan Achievement',
    ...
    'achievements':{
        ...
        'Dual Wielding':{
            'descriptionFull':'hubungkan 2 kontroler (perangkat keras atau aplikasi)',
            'descriptionFullComplete':'2 kontroler terhubung (perangkat keras atau aplikasi)',
            'name':'Dua Tangan'
        },
        'Flawless Victory':{
        ...
        'In Control':{
            'descriptionFull':'hubungkan kontroler (perangkat keras atau aplikasi)',
            'descriptionFullComplete':'kontroler terhubung (perangkat keras atau aplikasi)',
            'name':'Terkendali'
        },
        'Last Stand God':{
        ...
        'Precision Bombing':{
            'description':'Menang tanpa mengambil power-up',
            'descriptionComplete':'Menang tanpa mengambil power-up',
    ...
    'allowText':'Boleh',
    'alreadySignedInText':('akun anda telah masuk di media lain;\n'
                           'tolong beralih akun atau menutup game anda \n'
                           'yang ada di media lain dan mecoba lagi.'),
    ...
    'audioSettingsWindow':{
        ...
        'soundtrackDescriptionText':'(masukkan musik anda untuk diputar saat permainan)',
        'titleText':'Audio'
    },
    'autoText':'Otomatis',
    'backText':'Kembali',
    ...
    'configControllersWindow':{
        'configureControllersText':'Atur Kontroler',
        'configureKeyboard2Text':'Atur Keyboard Player 2',
        'configureKeyboardText':'Atur Keyboard',
        'configureMobileText':'Perangkat Handphone sebagai Kontroler',
        'configureTouchText':'Atur Kontrol Layar',
        'ps3Text':'Kontroler PS3',
        'titleText':'Kontroler',
        'wiimotesText':'Wiimote',
        'xbox360Text':'Kontroler Xbox 360'
    },
    'configGamepadSelectWindow':{
        'androidNoteText':'Catatan: kontroler dapat digunakan berdasarkan bersi Android anda.',
        'pressAnyButtonText':('Tekan tombol kontroller yang\n'
                              ' ingin anda atur,,,'),
        'titleText':'Konfigurasi Kontroler'
    },
    'configGamepadWindow':{
        'advancedText':'Lanjutan',
        'advancedTitleText':'Pengaturan Kontroler Lanjutan',
        ...
        'startButtonActivatesDefaultDescriptionText':'(Matikan jika tombol start anda lebih dari tombol \'menu\')',
    ...
    'configKeyboardWindow':{
        ...
        'keyboard2NoteText':('Catatan:  beberapa keyboard hanya dapat memasukan beberapa tombol yang ditekan pada satu waktu,\n'
                             ...
                             'Perlu dicatat bahwa anda masih butuh memasukan tombol unik untuk\n'
    ...
    'connectMobileDevicesWindow':{
        ...
        'bestResultsText':('Untuk hasil yang lebih baik, anda membutuhkan jaringan Wi-Fi yang bebas lag.\n'
                           'Anda dapat menurunkan lag Wi-Fi dengan cara mematikan alat wireless lainnya,\n'
        ...
        'explanationText':('Untuk menggunakan smartphone atau tablet sebagai pengontrol,\n'
                           'instal "${REMOTE_APP_NAME}" app. Alat apapun dapat tersambung ke\n'
    ...
    'coopSelectWindow':{
        ...
        'activenessInfoText':('Kelipatan ini naik di hari ketika anda bermain\n'
                              'dan turun di haru ketika anda tidak bermain'),
        'activityText':'Aktivitas',
        'campaignText':'Campaign',
        'challengesInfoText':('Dapatkan hadiah dengan menyelesaikan mini games\n'
                              '\n'
                              'Hadiah dan tingkat kesusahan level bertambah\n'
        ...
        'nextChallengeText':'Tantangan selanjutnya',
        'nextPlayText':'Permainan selanjutnya',
        ...
        'tournamentInfoText':('Bersaing untuk skor tinggi dengan\n'
                              'pemain lain di liga Anda.\n'
                              '\n'
                              'Hadiah diberikan ke atas\n'
                              'papan skor'),
        'welcome1Text':('Selamat datang ke ${LEAGUE}.Kamu bisa tingkatkan \n'
                        'ranking liga dengan dapatkan rating bintang, selesaikan \n'
                        'penghargaan dan menenangkan piala di turnamen'),
        'welcome2Text':('Kamu juga bisa mendapatkan tiket dari aktivitas yang sama.\n'
                        'Tiket bisa digunakan untuk membuka karakter baru, peta, dan\n'
                        'mini games,untuk masuk liga, dan lainnya'),
        'yourPowerRankingText':'Peringkat Kekuatan anda:'
    },
    ...
    'difficultyHardUnlockOnlyText':('Level ini khusus untuk mode sulit. \n'
    ...
    'editProfileWindow':{
        ...
        'localProfileInfoText':('Profile lokal tidak mempunyai ikon dan nama tidak terjamin unik.\n'
                                'Tingkatkan ke profil dunia untuk mendapatkan nama unik dan pemain bisa tambahkan ikon kustom'),
        ...
        'upgradeProfileInfoText':('Ini akan jadi nama anda dalam game ini\n'
                                  'dan memungkinkan Anda untuk menetapkan ikon kustom.'),
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('Ubah\n'
                    'Soundtrack'),
        'fetchingITunesText':'Mengambil playlist Itunes...',
        ...
        'useITunesPlaylistText':'Itunes Playlist',
    ...
    'gameListWindow':{
        'cantDeleteDefaultText':'Kamu tidak dapat menghapus daftar putar default.',
        'cantEditDefaultText':'tidak dapat mengubah Playlist Awal! Gandakan atau buat baru.',
        'cantShareDefaultText':'Kamu tidak bisa bagikan playlist semula',
    ...
    'gatherWindow':{
        'aboutDescriptionLocalMultiplayerExtraText':('Catatan: tiap perangkat bisa punya lebih dari\n'
                                                     'satu pemain jika memang ada kontroler yang cukup.'),
        'aboutDescriptionText':('Gunakan tab ini untuk mengadakan pesta.\n'
                                '\n'
                                'Dengan adanya pesta, Anda bisa bermain\n'
                                'dengan teman di perangkat yang berbeda.\n'
                                '\n'
                                'Gunakan tombol ${PARTY} di kanan atas\n'
                                'untuk chat dan berinteraksi di pesta. \n'
                                '(pada kontroler, tekan ${BUTTON} saat di menu)'),
        'aboutText':'Perihal',
        ...
        'bluetoothDescriptionText':'Buat/ikut pesta lewat Bluetooth:',
        'bluetoothHostText':'Adakan pesta!',
        'bluetoothJoinText':'Ikut pesta!',
        'bluetoothText':'Bluetooth',
        'checkingText':'sedang mengecek...',
        'dedicatedServerInfoText':'Untuk hasil terbaik, buatlah server yang bagus. lihat bombsquadgame.com/server untuk membuatnya',
        'disconnectClientsText':('${COUNT} pemain akan putus\n'
                                 'hubungan. Yakin?'),
        'earnTicketsForRecommendingAmountText':('Teman anda akan mendapatkan ${COUNT} tiket jika mereka memainkan game ini\n'
                                                '(dan anda akan mendapatkan ${YOU_COUNT} untuk setiap mereka memainkan game ini)'),
        'earnTicketsForRecommendingText':('Bagikan permainan\n'
                                          'untuk tiket gratis...'),
        'emailItText':'Lewat Email',
        ...
        'googlePlayReInviteText':('Ada ${COUNT} pemain Google Play di pestamu\n'
                                  'yang akan terputus jika Anda undang ulang. \n'
        ...
        'hostPublicPartyDescriptionText':'Buat pesta publik:',
        ...
        'inviteAFriendText':('Teman anda belum memainkan ini? undang mereka sekarang\n'
                             'dan mereka akan mendapatkan ${COUNT} tiket gratis.'),
        'inviteFriendsText':'Undang Teman',
        'joinPublicPartyDescriptionText':'Gabung ke pesta publik',
        'localNetworkDescriptionText':'Ikut pesta di jaringanmu:',
        'localNetworkText':'Jaringan Lokal',
        'makePartyPrivateText':'Buat pestaku pribadi',
        'makePartyPublicText':'Buat pestaku publik',
        'manualAddressText':'Alamat',
        'manualConnectText':'Hubungkan',
        'manualDescriptionText':'Ikut pesta di alamat:',
        'manualJoinableFromInternetText':'Apakah Anda bisa bergabung internet?:',
        'manualJoinableNoWithAsteriskText':'TIDAK*',
        'manualJoinableYesText':'IYA',
        'manualRouterForwardingText':'*perbaiki dengan mengonfigurasi router ke UDP port ${PORT} ke alamat lokal Anda',
        'manualText':'Manual',
        'manualYourAddressFromInternetText':'Alamat Anda dari internet:',
        'manualYourLocalAddressText':'Alamat lokal Anda:',
        ...
        'partyInviteIgnoreText':'Cuekin',
        'partyInviteText':('${NAME} mengundangmu\n'
                           'ke pestanya!'),
        'partyNameText':'Nama Pesta',
        'partySizeText':'ukuran',
        'partyStatusCheckingText':'memeriksa status...',
        'partyStatusJoinableText':'sekarang orang lain bisa gabung ke pestamu dari internet',
        'partyStatusNoConnectionText':'Gak bisa nyambung ke server',
        'partyStatusNotJoinableText':'orang lain gak bisa gabung ke pestamu lewat internet',
        'partyStatusNotPublicText':'pestamu bukan pesta publik',
        'pingText':'Ping',
        'portText':'Port',
        ...
        'showMyAddressText':'Liatin Alamatku',
        'titleText':'Gabung',
        'wifiDirectDescriptionBottomText':('Jika semua perangkat punya tab \'Wi-Fi Direct\', maka seharusnya semua bisa saling\n'
        ...
        'wifiDirectDescriptionTopText':('Wi-Fi Direct bisa digunakan untuk koneksi Android tanpa hotspot.\n'
        ...
        'youHaveBeenSentAPromoCodeText':'Kamu telah mengirim sebuah promo code ${APP_NAME}!'
    },
    'getTicketsWindow':{
        'freeText':'Gratis!',
        'freeTicketsText':'Tiket Gratis',
        'inProgressText':'Transaksi sedang dalam proses; sabar, coba lagi nanti.',
        ...
        'unavailableTemporarilyText':'maaf, saat ini sedang tidak tersedia; yang sabar ya.',
        'unavailableText':'maaf, tidak tersedia.',
        'versionTooOldText':'maaf, versi game anda sudah jadul, update lah tak payah bah.',
    ...
    'helpWindow':{
        ...
        'controllersInfoText':('Kamu dapat bermain ${APP_NAME} dengan temanmu melalui sebuah\n'
                               ...
                               'kontroler digital melalui aplikasi \'${REMOTE_APP_NAME}\'.\n'
        ...
        'controlsText':'Kontrol',
        'devicesInfoText':('Versi VR dari ${APP_NAME} bisa dimainkan lewat jaringan dengan\n'
                           'versi reguler. Jadi siapkan Handphone, Tablet atau Komputermu\n'
                           'dan Mainkan Game ini! Fitur ini juga dapat menjadi menyenangkan\n'
                           'dengan cara mengizinkan orang lain melihat permainan anda saat\n'
                           'menggunakan VR!'),
        ...
        'jumpInfoText':('- Lompat -\n'
                        ...
                        'mengekspresikan kebehagiaan anda.'),
        ...
        'powerupBombDescriptionText':('Memberikan anda 3 bom sekaligus.\n'
        ...
        'powerupHealthDescriptionText':('Mengembalikan darah anda\n'
                                        'seperti semula.'),
        'powerupHealthNameText':'Med-Pack',
        'powerupIceBombsDescriptionText':('Lebih lemah dari bomb biasa\n'
                                          'tapi membuat musuh anda beku,\n'
                                          'panik, galau, dan rapuh.'),
        ...
        'powerupShieldDescriptionText':('menahan beberapa serangan\n'
                                        'sehingga darah anda tidak berkurang.'),
        'powerupShieldNameText':'Energy-Sheild',
        'powerupStickyBombsDescriptionText':('lengket ke apapun yang tersentuh.\n'
                                             'Sungguh Menjijikan..'),
        'powerupStickyBombsNameText':'Sticky-Bombs',
        'powerupsSubtitleText':'Jelas sekali, tidak ada game yang bakal seru tanpa Powerups:',
        'powerupsText':'Powerups',
        'punchInfoText':('- Tinju -\n'
                         'akan lebih berguna saat\n'
                         'anda bergerak cepat. jadi lari\n'
                         'dan berputarlah seperti maddog.'),
        'runInfoText':('- Lari -\n'
                       'SEMUA tombol dapat digunakan untuk lari. Kecuali tombol pusar anda, haha. Lari\n'
                       'dapat membuat anda cepat tapi sulit untuk berbelok, jadi hati-hati dengan jurang.'),
    ...
    'internal':{
        ...
        'connectionFailedPartyFullText':'Koneksi gagal; pesta sudah penuh',
        ...
        'controllerDetectedText':'1 kontroler terdeteksi.',
        ...
        'controllerForMenusOnlyText':'kontroler ini tidak dapat digunakan untuk bermain, hanya untuk memilih menu.',
        'controllerReconnectedText':'${CONTROLLER} terhubung kembali.',
        'controllersConnectedText':'${COUNT} kontroler terhubung.',
        'controllersDetectedText':'${COUNT} kontroler terdeteksi.',
        'controllersDisconnectedText':'${COUNT} kontroler terputus.',
        'corruptFileText':'Data rusak terdeteksi. dimohon untuk re-installing, atau email ${EMAIL}',
        ...
        'incompatibleVersionHostText':('Host berjalan dengan versi yang berbeda dengan game.\n'
                                       'Pastikan anda up-to-date dan coba lagi'),
        ...
        'joinedPartyInstructionsText':('Seseorang bergabung di pestamu.\n'
        ...
        'kickIdlePlayersWarning2Text':'(anda bisa mematikan ini di Pengaturan -> Lanjutan)',
        'leftGameText':'Keluar \'${NAME}\'.',
        'leftPartyText':'Keluar dari pesta ${NAME}\'',
        'noMusicFilesInFolderText':'Folder tidak memiliki file musik.',
        'playerJoinedPartyText':'${NAME} bergabung ke pesta!',
        'playerLeftPartyText':'${NAME} kabur dari pesta.',
        'rejectingInviteAlreadyInPartyText':'Membatalkan undangan (sudah ada di pesta).',
        'serverRestartingText':'MEMULAI LAGI. Silahkan masuk sebentar lagi...',
        'signInErrorText':'Gagal masuk',
        'signInNoConnectionText':'Gagal masuk. (gak ada internet)',
        'telnetAccessDeniedText':'ERROR: pengguna tidak diberikan akses telnet.',
        'timeOutText':'(waktu habis ${TIME} detik lagi)',
        'touchScreenJoinWarningText':('Kau telah bergabung dengan layar sentuh.\n'
                                      'Jika ini kesalahan. tekan \'Menu->Males Main\' saja'),
        'touchScreenText':'Layar Sentuh',
        'unableToResolveHostText':'Error:Tidak bisa menyambung pada server',
        'unavailableNoConnectionText':'Maaf, sedang tidak tersedia (gak ada internet)',
        'vrOrientationResetCardboardText':('Gunakan ini untuk mengulang orientasi VR.\n'
                                           'Untuk memainkan game ini kau harus mempunyai kontroller luar.'),
    ...
    'jumpText':'Lompat',
    'keepText':'Simpan',
    'keepTheseSettingsText':'Simpan ini?',
    'kickOccurredText':'${NAME} dikeluarkan.',
    'kickQuestionText':'Keluarkan ${NAME}?',
    'kickText':'Keluarkan',
    'kickVoteFailedNotEnoughVotersText':'Tidak cukup pemain untuk pemilihan suara.',
    'kickVoteFailedText':'Pemilihan untuk kick gagal',
    'kickVoteStartedText':'Pemilihan suara untuk menendang ${NAME} sudah dimulai.',
    'kickVoteText':'Pemilihan untuk kick',
    'kickWithChatText':'Tulis ${YES} di chat kalo ya dan ${NO} untuk tidak.',
    ...
    'league':{
        ...
        'tournamentLeagueText':'Kau harus berada di liga ${NAME} untuk memasukinya',
    ...
    'macControllerSubsystemDescriptionText':'Coba ubah ini jika kontroler anda tidak bekerja',
    'macControllerSubsystemMFiNoteText':('Dibuat-untuk-ios/Mac kontroler terdeteksi;\n'
                                         'Kau mungkin ingin mengaktifkanya melalui pengaturan -> kontroler'),
    ...
    'mainMenu':{
        ...
        'endGameText':'Akhiri Game',
        'exitGameText':'Keluar Game',
        'exitToMenuText':'Ke Menu?',
        'howToPlayText':'Cara bermain',
        'justPlayerText':'(Hanya ${NAME})',
        'leaveGameText':'Males Main',
        'leavePartyConfirmText':'Yakin Minggat?',
        'leavePartyText':'Minggat',
        'quitText':'Berhenti',
        'resumeText':'Lanjut',
    ...
    'maxPartySizeText':'Ukuran Maksimal',
    'maxPlayersText':'Pemain maksimal',
    'mostValuablePlayerText':'Pemain unggulan',
    ...
    'mustInviteFriendsText':('NB: kamu harus undang teman di\n'
                             'panel "${GATHER}" atau pasang\n'
                             'kontroler untuk multiplayer'),
    'nameBetrayedText':'${NAME} membangkang pada ${VICTIM}',
    ...
    'nextAchievementsText':'Pencapaian selanjutnya:',
    'nextLevelText':'Level Selanjutnya',
    'noAchievementsRemainingText':'- tidak ada',
    'noContinuesText':'(tidak bisa melanjutkan)',
    ...
    'notEnoughPlayersText':'Kamu butuh minimal ${COUNT} pemain untuk memulai permainan!',
    'notNowText':'Jangan Sekarang',
    'notSignedInErrorText':'Kau harus masuk untuk lakukan ini.',
    'notSignedInGooglePlayErrorText':'Kau harus masuk pakai Google Play untuk lakukan ini.',
    'notSignedInText':'belum masuk',
    'nothingIsSelectedErrorText':'Tidak ada terpilih!',
    'numberText':'#${NUMBER}',
    'offText':'Mati',
    'okText':'Okey',
    'onText':'Nyala',
    ...
    'ownFlagAtYourBaseWarning':('Benderamu harus\n'
                                'ada di tempatnya!'),
    'packageModsEnabledErrorText':'Game-jaringan tidak diperbolehkan ketika mod-paket-lokal diaktifkan (lihat Pengaturan->Lanjutan)',
    'partyWindow':{
        'chatMessageText':'Pesan Obrolan',
        'emptyText':'Pestamu kosong',
        'hostText':'(pembuat)',
        'sendText':'Kirim',
        'titleText':'Pestamu'
    },
    'pausedByHostText':'(terhenti oleh tuan rumah)',
    ...
    'playerDelayedJoinText':'${PLAYER} akan masuk pada ronde selanjutnya.',
    'playerInfoText':'Info Pemain',
    'playerLeftText':'${PLAYER} meninggalkan game.',
    'playerLimitReachedText':'Batas pemain ${COUNT} tercapai; tidak bisa bergabung lagi.',
    'playerProfilesWindow':{
        'cantDeleteAccountProfileText':'Kau tidak bisa menghapus akun profilmu.',
        'deleteButtonText':('Hapus\n'
                            'Profil'),
        'deleteConfirmText':'Hapus \'${PROFILE}\'?',
        'editButtonText':('Ubah\n'
                          'Profil'),
        'explanationText':'(nama-nama pemain kustom dan penampilan untuk akun ini)',
    ...
    'pleaseRateText':('Jika kau menyukai ${APP_NAME},silahkan memberi waktu sedikit untuk menilai atau menulis komentar. Ini membantu kami untuk menyempurnakan permainan di masa mendatang.\n'
                      '\n'
                      'terima kasih!\n'
                      '-eric'),
    'pleaseWaitText':'Mohon tunggu...',
    'practiceText':'Latihan',
    'pressAnyButtonPlayAgainText':'Tekan tombol apa saja untuk main lagi...',
    'pressAnyButtonText':'Tekan tombol apa saja untuk lanjut...',
    'pressAnyButtonToJoinText':'tekan apa saja untuk bergabung...',
    'pressAnyKeyButtonPlayAgainText':'Tekan apa saja untuk main lagi...',
    'pressAnyKeyButtonText':'Tekan apa saja untuk lanjut...',
    'pressAnyKeyText':'Tekan apa saja...',
    'pressJumpToFlyText':'** Tekan lompat berkali-kali untuk terbang **',
    'pressPunchToJoinText':'tekan PUKUL untuk masuk..',
    ...
    'ps3ControllersWindow':{
        'macInstructionsText':('Matikan daya pada bagian belakang PS3mu, pastikan\n'
                               ...
                               'ke Mac-mu dengan kabel USB untuk memasangkannya. Sekarang, kau\n'
                               'bisa menggunakan kontrollermu dengan kabel USB atau Bluetooth.\n'
                               '\n'
                               'Pada beberapa Mac kau mungkin akan dimintai kode password ketika memasangkannya.\n'
                               ...
                               '\n'
                               '\n'
                               'Kontroller PS3 yang terhubung dengan jaringan akan terlihat pada daftar alat\n'
                               'dalam System Preferences->Bluetooth. Kau mungkin harus menghapusnya\n'
                               'dalam daftar itu ketika kau ingin menggunakan kontroller PS3mu lagi.\n'
                               '\n'
                               'Dan pastikan untuk memutuskannya dari Bluetooth ketika sedang tidak\n'
                               'digunakan atau baterainya akan terus-menerus habis.\n'
                               '\n'
        ...
        'ouyaInstructionsText':('Untuk menggunakan kontroller PS3mu dengan OUYA, hubungkan saja dengan kabel USB\n'
                                ...
                                'kau harus mengulang OUYA-mu dan cabut kabel USB.\n'
                                '\n'
                                'Sekarang kau seharusnya bisa menggunakan kontrollermu untuk\n'
                                'menghubungkannya dengan jaringan. Ketika kau sudah selesai bermain, tekan tombol HOME\n'
    ...
    'remoteAppInfoShortText':('${APP_NAME} akan menyenangkan ketika dimainkan dengan keluarga & teman.\n'
                              ...
                              '${REMOTE_APP_NAME} pada handphone atau tablet untuk menggunakannya\n'
                              'sebagai kontroller.'),
    'remote_app':{
        'app_name':'Remot BombSquad',
        'app_name_short':'BSRemot',
        'button_position':'Posisi Tombol',
        'button_size':'Ukuran Tombol',
        'cant_resolve_host':'Tidak bisa menemukan pembuat.',
        'capturing':'Menangkap…',
        'connected':'Terhubung.',
        'description':('Gunakan HP atau tabletmu sebagai pengontrol dengan BombSquad.\n'
                       'Lebih dari 8 perangkat bisa terhubung sekaligus untuk kegilaan multipemain lokal yang epik di sebuah TV atau tablet'),
        ...
        'game_full':'Game sudah penuh atau tidak menerima koneksi.',
        'game_shut_down':'Game sudah mati',
        ...
        'searching_caption':('Tekan nama dari game yang ingin dimasuki.\n'
                             'Pastikan kau berada di jaringan wifi yang sama dengan gamenya.'),
        'start':'Mulai',
        'version_mismatch':('Versi tidak sama.\n'
                            'Pastikan BombSquad dan Remot BombSquad\n'
                            'adalah versi terbaru dan coba lagi.')
    },
    ...
    'replayRenameWarningText':'Ubah nama "${REPLAY}" setelah game jika kau ingin menyimpannya; jika tidak itu akan ditimpa.',
    'replayVersionErrorText':('Maaf, replay ini dibuat dalam\n'
                              'versi game yang berbeda dan tidak bisa digunakan'),
    'replayWatchText':'Nonton Replay',
    'replayWriteErrorText':'Error menulis file replay',
    'replaysText':'Replay',
    'reportPlayerExplanationText':('Gunakan email ini untuk melaporkan tindakan curang, kata-kata yang tidak pantas, atau kelakuan buruk lainnya.\n'
                                   'Tolong jelaskan dibawah ini:'),
    'reportThisPlayerCheatingText':'Curang',
    'reportThisPlayerLanguageText':'Bahasa Yang Tidak Pantas',
    'reportThisPlayerReasonText':'Apa yang ingin kau laporkan?',
    ...
    'settingsWindowAdvanced':{
        ...
        'helpTranslateText':('Translasi ${APP_NAME} selain Inggris adalah bantuan \n'
                             ...
                             'translasi, masuk ke situs berikut. Terima kasih!'),
        'kickIdlePlayersText':'Keluarkan Pemain diam',
        'kidFriendlyModeText':'Mode Anak (kekerasan rendah, dll)',
        'languageText':'Bahasa',
        'moddingGuideText':'Cara Modding',
        'mustRestartText':'Anda harus memulai lagi game untuk mendapatkan efek.',
        'netTestingText':'Tes Jaringan',
        'resetText':'Atur ulang',
        'showBombTrajectoriesText':'Lihat Lintasan Bom',
        'showPlayerNamesText':'Lihat Nama Pemain',
        'showUserModsText':'Lihat Folder Mod',
        'titleText':'Lanjutan',
        'translationEditorButtonText':'Pengedit Translasi ${APP_NAME}',
        'translationFetchErrorText':'status translasi tidak tersedia.',
        'translationFetchingStatusText':'mengecek status translasi',
        'translationInformMe':'Beritahu saya jika bahasa saya harus diperbarui',
        'translationNoUpdateNeededText':'bahasa ini sudah up-to-date; woohoo !',
        'translationUpdateNeededText':'** bahasa ini masih harus diupdate! **',
    ...
    'store':{
        ...
        'extrasText':'Extra',
        'freeBombSquadProText':('BombSquad sekarang gratis, tapi karena dulu kau membelinya\n'
                                'kau mendapat tingkatan BombSquad Pro dan ${COUNT} tiket sebagai ucapan terima kasih.\n'
                                'Nikmati fitur barunya, dan terima kasih dukugannya!\n'
                                '-Eric'),
        'holidaySpecialText':'Spesial Liburan',
        'howToSwitchCharactersText':'pergi ke "${SETTINGS} -> ${PLAYER_PROFILES}" untuk merubah karakter',
        ...
        'iconsText':'Simbol',
        'loadErrorText':('Tidak bisa memuat halaman.\n'
        ...
        'youOwnThisText':'- kau sudah memiliki ini -'
    },
    'storeDescriptionText':('Permainan dengan 8 pemain!\n'
                            '\n'
                            'Ledakkan temanmu (atau NPC) dalam turnament ledakkan seperti Ambil-Bendera, Hoki-Bom,\n'
                            'dan Pertarungan-Mematikan-Epik-Gerakkan-Lambat\n'
                            '\n'
                            'Dukungan kontroller Sederhana dan kontroller luas membuatnya mudah untuk 8 orang untuk beraksi;\n'
                            'kau juga bisa menggunakan perangkat handphonemu sebagai kontroller dengan app ‘BombSquad Remote’!\n'
                            'Bom Terlempar!\n'
                            'Cek www.froemling.net/bombsquad untuk info lebih lanjut.'),
    'storeDescriptions':{
    ...
    'testBuildValidateErrorText':'Tidak bisa mengesahkan percobaan. (Tidak ada koneksi internet?)',
    'testBuildValidatedText':'Percobaan Sah; Nikmati!',
    'thankYouText':'Terima kasih atas dukungan mu! Nikmati gamenya!!',
    'threeKillText':'PEMBUNUHAN TIGA KALI LIPAT!!',
    'timeBonusText':'Waktu Bonus',
    ...
    'tournamentCheckingStateText':'Memeriksa keadaan turnament; harap tunggu...',
    'tournamentEndedText':'Turnament sudah berakhir. Turnament yang baru akan mulai segera.',
    'tournamentEntryText':'Biaya Masuk Turnament',
    'tournamentResultsRecentText':'Hasil Turnament Baru Saja',
    'tournamentStandingsText':'Hasil Terbaik Turnament',
    'tournamentText':'Turnamen',
    'tournamentTimeExpiredText':'Waktu Turnament Berakhir',
    'tournamentsText':'Turnament',
    'translations':{
        'characterNames':{
        ...
        'gameDescriptions':{
            ...
            'How fast can you defeat the ninjas?':'Mampukah Anda menjadi Hokage?',
        ...
        'playlistNames':{
            'Just Epic':'Cukup Epik',
            'Just Sports':'Cukup Olahraga'
        },
        'scoreNames':{
            'Flags':'Bendera',
            'Goals':'Gol',
        ...
        'serverResponses':{
            ...
            ('Are you sure you want to link these accounts?\n'
             ...
             '${ACCOUNT2}\n'
             '\n'
             'This cannot be undone!'):('Kau yakin ingin menghubungkan akun ini?\n'
                                        '\n'
                                        '${ACCOUNT1}\n'
                                        '${ACCOUNT2}\n'
                                        '\n'
            ...
            'Can\'t link 2 accounts of this type.':'Tidak bisa menghubungkan 2 tipe akun ini.',
            'Can\'t link 2 diamond league accounts.':'Tidak bisa menghubungkan 2 akun liga intan.',
            'Can\'t link; would surpass maximum of ${COUNT} linked accounts.':'Tidak bisa menghubungkan; akan melampaui batas maksimum ${COUNT} akun yang dihubungkan.',
            ...
            'Could not establish a secure connection.':'Tidak bisa menyeimbangkan koneksi yang aman.',
            ...
            'Profile could not be upgraded.':'Profile tidak bisa di tingkatkan.',
            ...
            ('Server functionality is no longer supported in this version of the game;\n'
             'Please update to a newer version.'):('Fungsi server tidak lagi didukung dalam versi game ini;\n'
                                                   'Silahkan update ke versi yang lebih baru.'),
            'Sorry, there are no uses remaining on this code.':'Maaf, kode ini tidak bisa dipakai lagi',
            ...
            'The tournament ended before you finished.':'Turnamen berakhir sebelum kau selesai.',
            ...
            ('WARNING: complaints of hacking have been issued against your account.\n'
             'Accounts found to be hacking will be banned.  Please play fair.'):('PERINGATAN: keluhan tentang kecurangan telah diajukan terhadap akun Anda.\n'
            ...
            ('Would you like to link your device account to this one?\n'
             ...
             'Warning: this cannot be undone!\n'):('Apakah kau mau menghubungkan akun perangkatmu dengan yang ini>\n'
                                                   '\n'
            ...
            'You already own this!':'Kau sudah mempunyai ini!',
            'You can join in ${COUNT} seconds.':'Kamu dapat bergabung lagi pada ${COUNT} detik',
            'You don\'t have enough tickets for this!':'Kau tidak mempunyai cukup tiket untuk ini!',
            'You don\'t own that.':'Kamu tidak memiliki itu.',
            'You got ${COUNT} tickets!':'Kau dapat ${COUNT} tiket!',
            'You got a ${ITEM}!':'Kamu dapat ${ITEM}!',
            'You have been promoted to a new league; congratulations!':'Kau dipromosikan ke liga yang baru; selamat!',
            'You must update to a newer version of the app to do this.':'Kau harus perbarui app ke versi yang baru untuk melakukan ini.',
            'You must update to the newest version of the game to do this.':'Kamu harus update ke versi game yang lebih baru untuk melakukan ini.',
            'You must wait a few seconds before entering a new code.':'Kau harus menunggu beberapa detik sebelum memasukkan kode yang baru.',
            'You ranked #${RANK} in the last tournament. Thanks for playing!':'Kau rangking #${RANK} dalam turnament terakhir. Terima kasih sudah bermain!',
        ...
        'settingNames':{
            ...
            '5 Minutes':'5 Menit',
            '8 Seconds':'8 detik',
            'Allow Negative Scores':'Ijinkan Skor Negatif',
            ...
            'Chosen One Gets Shield':'Terpilih akan mendapatkan tameng',
            'Chosen One Time':'Waktu Yang Terpilih',
            'Enable Impact Bombs':'Ijinkan Dampak Bom',
            'Enable Triple Bombs':'Ijinkan Bom Rangkap Tiga',
            ...
            'Normal':'Sedang',
            'Pro Mode':'Mode Ahli',
            'Respawn Times':'Waktu muncul kembali',
            'Score to Win':'Skor menang',
            'Short':'Pendek',
            'Shorter':'Pendek sekali',
            'Solo Mode':'Mode Solo',
            'Target Count':'Berapa Target',
        ...
        'tips':{
            ('A perfectly timed running-jumping-spin-punch can kill in a single hit\n'
             'and earn you lifelong respect from your friends.'):('Larian-lompatan-putaran-pukulan sempurna pada waktu yang tepat bisa membunuh dengan\n'
                                                                  'sekali serangan dan dapatkan penghargaan dari temanmu.'),
            ...
            'Don\'t get too cocky with that energy shield; you can still get yourself thrown off a cliff.':'Jangan terlalu sombong dengan perisai energi; kau masih bisa dibuang ke dalam jurang.',
            'Don\'t run all the time.  Really.  You will fall off cliffs.':'Jangan selalu berlari atau kau akan jatuh ke jurang.',
            ...
            ('Hold down any button to run. You\'ll get places faster\n'
             'but won\'t turn very well, so watch out for cliffs.'):('Tahan tombol apa saja untuk lari. Kau akan menjadi lebih cepat\n'
                                                                     'tapi tidak bisa berbelok dengan lancar, hati-hati dengan jurang.'),
            ...
            ('If you are short on controllers, install the \'${REMOTE_APP_NAME}\' app\n'
             'on your mobile devices to use them as controllers.'):('Jika kau tidak mempunyai kontroller, pasang app \'${REMOTE_APP_NAME}\n'
            ...
            'If you kill an enemy in one hit you get double points for it.':'Jika kau membunuh musuh dengan sekali serang maka kau akan mendapat poin ganda.',
            ('If you pick up a curse, your only hope for survival is to\n'
             'find a health powerup in the next few seconds.'):('Jika kau mengambil kutukan, satu-satunya harapanmu untuk hidup adalah\n'
                                                                'menemukan kotak medis dalam 5 detik.'),
            'If you stay in one place, you\'re toast. Run and dodge to survive..':'Jika kau berdiam diri saja, maka kau akan tamat. Lari dan menghindar untuk tetap hidup..',
            ('If you\'ve got lots of players coming and going, turn on \'auto-kick-idle-players\'\n'
             'under settings in case anyone forgets to leave the game.'):('Jika kau mendapat banyak pemain yang masuk dan bergabung, aktidkan \'auto-kick-idle-players\'\n'
            ...
            ('If your device gets too warm or you\'d like to conserve battery power,\n'
             'turn down "Visuals" or "Resolution" in Settings->Graphics'):('Jika perangkatmu mulai panas atau kau mau menghemat baterai,\n'
            ...
            'In hockey, you\'ll maintain more speed if you turn gradually.':'Dalam hoki, kau bisa mempertahankan kecepatanmu jika kau berbelok secara bertahap.',
            ...
            ('Many things can be picked up and thrown, including other players.  Tossing\n'
             'your enemies off cliffs can be an effective and emotionally fulfilling strategy.'):('Banyak hal yang bisa diambil dan dilempar, termasuk pemain lain. Membuang\n'
                                                                                                  'musuhmu ke jurang akan lebih efektif.'),
            'No, you can\'t get up on the ledge. You have to throw bombs.':'Tidak, kau tidak bisa melewati pembatas. Kau harus melempar bom.',
            ('Players can join and leave in the middle of most games,\n'
             'and you can also plug and unplug controllers on the fly.'):('Pemain bisa masuk dan keluar ditengah-tengah permainan,\n'
                                                                          'dan kau juga bisa menyambung dan memutuskan kontroller.'),
            ...
            ('Punches do more damage the faster your fists are moving,\n'
             'so try running, jumping, and spinning like crazy.'):('Pukulan mendapatkan lebih banyak serangan ketika kau\n'
            ...
            ('Throw strength is based on the direction you are holding.\n'
             'To toss something gently in front of you, don\'t hold any direction.'):('Kekuatan lemparan tergantung dimana kau melempar.\n'
                                                                                      'Jika kau ingin melempar lebih lembut, jangan terlalu banyak bergerak.'),
            ...
            'Use the pick-up button to grab the flag < ${PICKUP} >':'Gunakkan tombol pengambil untuk mengambil bendera < ${PICKUP} >',
            'Whip back and forth to get more distance on your throws..':'Jalan maju mundur untuk melempar lebih jauh..',
            ('You can \'aim\' your punches by spinning left or right.\n'
             'This is useful for knocking bad guys off edges or scoring in hockey.'):('Kau bisa \'arahkan\' tinjumu dengan memutar ke kiri dan kanan.\n'
                                                                                      'Ini berguna untuk memukul musuh di tepi atau membuat gol di hoki.'),
            ('You can judge when a bomb is going to explode based on the\n'
             'color of sparks from its fuse:  yellow..orange..red..BOOM.'):('Kamu bisa melihat bom yang akan meledak dengan melihat warna percikan bom itu sendiri:\n'
                                                                            'Kuning...Jingga..Merah..KABOOM'),
            'You can throw bombs higher if you jump just before throwing.':'Kamu bisa lempar bom lebih tinggi jika kamu lompat sebelum lemapar',
    ...
    'trophiesRequiredText':'Ini membutuhkan kira-kira ${NUMBER} piala.',
    'trophiesText':'Trofi',
    ...
    'tutorial':{
        ...
        'phrase04Text':'Banyak hal di ${APP_NAME} yang berdasarkan pada FISIKA',
        'phrase05Text':'Misal,  ketika kamu meninju....',
        'phrase06Text':'... kecepatan lenganmu memengaruhi tinjuanmu.',
        'phrase07Text':'Ya to? Kamu cuma diem,  jadi ${NAME} cuma kegelian.',
        'phrase08Text':'Nah, coba kalau muter sambil lompat agar tambah cepat.',
        'phrase09Text':'Hmm, mendingan lah',
        ...
        'phrase14Text':'Kamu bisa mengangkat lalu melempar barang, bendera, dan....  ${NAME}',
        'phrase15Text':'Terakhir, BOM.',
        'phrase16Text':'Melempar bom butuh latihan.',
        'phrase17Text':'Aw! Lemparanmu jelek banget!',
        ...
        'phrase21Text':'Mengatur waktu bom bisa jadi sulit.',
        'phrase22Text':'Anjing. Ga kena.',
        'phrase23Text':'Tunggu bom sampai matang dulu lalu lempar.',
        'phrase24Text':'Yes! Mantap.',
        'phrase25Text':'Hanya itu saja.',
        'phrase26Text':'Hantam mereka, Joe!',
        'phrase27Text':'Ingat latihanmu, agar kamu bisa kembali hidup-hidup!',
        'phrase28Text':'... em,  mungkin sih...',
        'phrase29Text':'Semoga beruntung coeg !',
        'randomName1Text':'Diwang',
        'randomName2Text':'Dion',
        'randomName3Text':'Yonas',
        'randomName4Text':'Andre',
        'randomName5Text':'Niko',
        'skipConfirmText':'Yakin skip tutorial? Tekan apa saja untuk konfirmasi.',
        'skipVoteCountText':'${COUNT}/${TOTAL} suara untuk skip',
        'skippingText':'Skip...',
        'toSkipPressAnythingText':'(tekan apa saja untuk skip tutorial)'
    },
    'twoKillText':'MATI DOBEL!',
    'unavailableText':'tidak tersedia',
    'unconfiguredControllerDetectedText':'Kontroler belum terkonfigurasi terdeteksi:',
    'unlockThisInTheStoreText':'Tersedia di toko terdekat.',
    'unlockThisProfilesText':'Untuk membuat lebih dari ${NUM} profil, anda memerlukan:',
    'unlockThisText':'Untuk buka ini,kamu membutuhkan:',
    'unsupportedHardwareText':'Maaf, perangkat ini tidak mendukung.',
    'upFirstText':'Game pertama:',
    'upNextText':'${COUNT} game selanjutnya:',
    'updatingAccountText':'Mengupdate akun...',
    'upgradeText':'Tingkatkan',
    'upgradeToPlayText':'Buka "${PRO}" di toko game untuk bermain.',
    'useDefaultText':'Gunakan Default',
    'usesExternalControllerText':'Game ini menggunajan kontroler external untuk input.',
    'usingItunesText':'Menggunakan soundtrack dari iTunes...',
    ...
    'victoryText':'Menang!',
    'voteDelayText':'Kau tidak bisa memulai pemilihan suara dalam ${NUMBER} detik',
    'voteInProgressText':'Pemilihan suara sedang dalam proses.',
    'votedAlreadyText':'Kau sudah memilih suara',
    'votesNeededText':'${NUMBER} suara dibutuhkan',
    'vsText':'lw.',
    'waitingForHostText':'(menunggu ${HOST} untuk lanjut)',
    'waitingForPlayersText':'menunggu pemain untuk ikut...',
    'waitingInLineText':'Mengantri (pesta penuh)...',
    ...
    'watchWindow':{
        ...
        'replayRenameErrorInvalidName':'Tidak bisa menganti nama replay; nama invailid',
        'replayRenameErrorText':'Error mengganti nama replay',
        'sharedReplaysText':'Replay dibagi',
        'titleText':'Nonton',
    ...
    'wiimoteSetupWindow':{
        ...
        'macInstructionsText':('Pastika Wii-mu mati dan Bluetooth hidup\n'
                               ...
                               'bisa sedikit sulit, jadi kau harus mencoba beberapa kali\n'
                               'sebelum kau mempunyai koneksi.\n'
                               '\n'
                               'Bluetooth seharusnya bisa mengatasi sampai 7 perangkat yang terhubung\n'
    ...
    'xbox360ControllersWindow':{
        ...
        'macInstructions2Text':('Untuk menggunakan stik wireless, anda juga memerlukan wireless receiver\n'
                                'yang termasuk bagian dari \'Xbox 360 Wireless Controller for Windows\'.\n'
                                'Satu receiver dapat digunakan untuk hingga 4 stik/kontroler.\n'
                                '\n'
                                'Penting: receiver pihak ketiga biasanya tidak dapat digunakan dengan driver ini;\n'
                                'pastikan pada receiver anda tertulis logo \'Microsoft\', bukan logo \'XBOX360\'.\n'
                                'Microsoft tidak menjual receiver secara terpisah lagi, jadi anda harus\n'
                                'membeli stik yang termasuk receiver, atau cari di ebay/kaskus.\n'
                                '\n'
                                'Jika anda berpikir ini berguna, tolong pertimbangkan untuk donasi kepada\n'
                                'pengembang/developer driver tersebut pada situsnya.'),
        'macInstructionsText':('Untuk menggunakan stik Xbox 360, anda perlu menginstall\n'
        ...
        'ouyaInstructionsText':('Untuk menggunakan stik Xbox 360 kabel, tancapkan\n'
                                'kabel USB ke komputer anda. Anda dapat menggunakan USB hub\n'
                                'untuk menancapkan banyak stik/kontroler\n'
                                '\n'
                                'Untuk menggunakan stik wireless anda perlu wireless reciever,\n'
                                ...
                                'menyambunggkan sampai 4 buah stik/kontroler.'),
        'titleText':'Menggunakan kontroler Xbox 360 dengan ${APP_NAME}:'
    },
    'yesAllowText':'Boleh!',
