...
values = {
    'accountSettingsWindow':{
        'accountNameRules':'账户名称不可包含emoji或其它特殊符号',
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('编辑自定义\n'
                    '背景音乐'),
        'fetchingITunesText':'正在获取iTunes播放列表',
        ...
        'useITunesPlaylistText':'iTunes播放列表',
        'useMusicFileText':'音乐文件（mp3等）',
    ...
    'gatherWindow':{
        ...
        'localNetworkDescriptionText':'在您的网络中加入派对：',
    ...
    'helpWindow':{
        ...
        'powerupLandMinesDescriptionText':('大特价，一包3个。\n'
                                           '居家旅行，防守阵地的不二选择，\n'
                                           '还可以阻止那些跑的飞快的敌人。'),
    ...
    'internal':{
        ...
        'serverRestartingText':'正在重启，请等一下再加入…',
    ...
    'usingItunesText':'使用iTunes设置背景音乐……',
    ...
    'wiimoteListenWindow':{
        ...
        'pressText2':'在较新的安装有Motion Plus的Wiimotes上，可按下背部的红色“同步”按钮作为替代。'
    },
    'wiimoteSetupWindow':{
    ...
    'xbox360ControllersWindow':{
        ...
        'macInstructions2Text':('如要使用无线手柄，您还需要\n'
                                ...
                                '网站进行捐赠。'),
        'macInstructionsText':('如要使用Xbox 360手柄，您需要安装\n'
                               '通过以下链接所获得的Mac驱动程序。\n'
                               '该驱动程序与有线和无线手柄二者兼容。'),
        'ouyaInstructionsText':('如要在BombSquad中使用有线Xbox 360手柄，只需\n'
