...
values = {
    'accountSettingsWindow':{
        'accountNameRules':'खाता नाम में इमोजी या अन्य विशेष वर्ण नहीं हो सकते',
        ...
        'changeOncePerSeason':'आप केवल प्रति सीजन में इस बार बदल सकते हैं',
        'changeOncePerSeasonError':'आपको इसे फिर से बदलने के लिए अगले सीज़न तक इंतजार करना होगा (${NUM} days)',
        ...
        'linkAccountsInstructionsText':('दो खातों को जोड़ने के लिए एक में कोड उत्पन्न\n'
                                        'करें एयर दुसरे खाते में दर्ज करें | प्रगति और\n'
                                        'वस्तुसूची जोड़ दी जायेगी | आप अधिकतम\n'
                                        '${COUNT} खातों को जोड़ सकते हैं |\n'
                                        '\n'
                                        'ध्यान रखिये, इसे वापस नहीं लिया जा सकता !'),
        'linkAccountsText':'खाते को जोडिए',
        'linkedAccountsText':'जुड़े हुए खाते:',
        'nameChangeConfirm':'${NAME} में अपना खाता नाम बदलें?',
        ...
        'setAccountName':'खाता नाम सेट करें',
        ...
        'testAccountWarningOculusText':('चेतावनी: आप एक "परीक्षा" खाते से साइन इन कर रहे हैं |\n'
                                        'यह आपके औक्युलस खाते से बदल दिया जायेगा इस साल के अंत तक जब टिकेट खरीदने व आदि विशेषताएं इस गेम में जोड़ दी जायेंगी |\n'
                                        '\n'
                                        'अभी के लिए आपको टिकेट गेम के अन्दर से ही कमाने होंगे |\n'
                                        '(आपको बम स्क्वाड प्रो का उन्नयन मुफ्त में दिया जाएगा |)'),
    ...
    'achievements':{
        ...
        'Dual Wielding':{
            'descriptionFull':'दो कंट्रोलर (हार्डवेयर या ऍप) जोड़िये',
        ...
        'Free Loader':{
            'descriptionFull':'फ्री-फॉर-ऑल गेम दो से ज्यादा खिलाड़ियोंके साथ शुरू कीजिए',
        ...
        'In Control':{
            ...
            'descriptionFullComplete':'एक नियंत्रक जोड़ा गया(हार्डवेयर या ऐप)',
            'name':'नियंत्रण मे'
        },
        'Last Stand God':{
        ...
        'Onslaught Training Victory':{
            ...
            'descriptionFull':'साड़ी लहरों को पार करें स्तर ${LEVEL} में |',
            'descriptionFullComplete':'साड़ी लहरों को पार किया स्तर ${LEVEL} में |',
            'name':'${LEVEL} पर विजय'
        },
        'Onslaught Wizard':{
    ...
    'achievementsUnavailableForOldSeasonsText':'माफ़ करें उपलब्धियों कि जानकारी पुराने सीजन से नहीं है',
    'addGameWindow':{
    ...
    'audioSettingsWindow':{
        'headRelativeVRAudioInfoText':'("स्वयं" इसे तभी शुरू करेगा जब हैडफ़ोन लगें हों)',
    ...
    'bestOfSeriesText':'${COUNT} सीरीज़ का सर्वोच्च',
    'bestRankText':'आपका सबसे अच्छा पद है #${RANK}',
    'bestRatingText':'आपका सबसे अच्छा मूल्यांकन है ${RATING}',
    'bombBoldText':'बम',
    'bombText':'बम',
    'boostText':'प्रोत्साहन',
    'bsRemoteConfigureInAppText':'${REMOTE_APP_NAME} को एप्लीकेशन के अन्दर से ही कॉन्फ़िगर करें |',
    'buttonText':'बटन',
    ...
    'cantConfigureDeviceText':'माफ़ करें  ${DEVICE} कांफिग्युरेब्ल नहीं है |',
    ...
    'choosingPlayerText':'<खिलाड़ी चुना जा रहा है>',
    'completeThisLevelToProceedText':'आपको यह पड़ाव पार करना पड़ेगा आगे बढ़ने के लिए !',
    'completionBonusText':'पूर्णता पुरस्कार',
    'configControllersWindow':{
        'configureControllersText':'नियंत्रक को कॉन्फ़िगर करें',
        'configureKeyboard2Text':'कीबोर्ड पी २ को कॉन्फ़िगर करें',
        'configureKeyboardText':'कीबोर्ड को कॉन्फ़िगर करें',
        'configureMobileText':'मोबाइल यंत्रों को नियंत्रक के रूप में',
        'configureTouchText':'टच स्क्रीन को कॉन्फ़िगर करें',
    ...
    'configGamepadSelectWindow':{
        ...
        'pressAnyButtonText':'जिस भी नियंत्रक को आप कॉन्फ़िगर करना चाहते हैं उस पर कोई भी बटन दबाएँ ...',
        'titleText':'नियंक्त्रकों को कॉन्फ़िगर करें'
    },
    'configGamepadWindow':{
        'advancedText':'उन्नत सेटिंग्स',
        'advancedTitleText':'उन्नत सेटिंग्स नियंत्रक सेटअप',
        'analogStickDeadZoneDescriptionText':'(इसको बढ़ाएं अगर आपकी प्रकृति नियंत्रण छोड़ने पर भी हिलती है )',
        'analogStickDeadZoneText':'अनुरूप छड़ी का मृत क्षेत्र',
        ...
        'autoRecalibrateText':'अनुरूप छड़ी का पुनः व्यास मापन करें',
        'axisText':'धुरी',
        'clearText':'खाली करें',
        'dpadText':'डी-पैड',
        'extraStartButtonText':'अतिरिक्त प्रारंभ करने का बटन',
        'ifNothingHappensTryAnalogText':'अगर कुछ नहीं होता है तो अनुरूप छड़ी को निर्दिष्ट करने का प्रयास करें',
        ...
        'runButton1Text':'दोड़ने का पहला बटन',
        'runButton2Text':'दोड़ने का दूसरा बटन',
        'runTrigger1Text':'दोड़ने का पहला संकेत',
        'runTrigger2Text':'दोड़ने का दूसरा संकेत',
        'runTriggerDescriptionText':'(अनुरूप संकेत आपको परिवर्तनशील गति से दोड़ने दे सकता है)',
        'secondHalfText':('इसका प्रयोग करके एक में दो वाले \n'
                          'यंत्र को कॉन्फ़िगर करें जो एक यंत्र  \n'
    ...
    'configKeyboardWindow':{
        'configuringText':'${DEVICE} को कॉन्फ़िगर किया जा रहा है',
        'keyboard2NoteText':('टिपण्णी: अधिकतर कीबोर्ड एक बार में कुछ ही \n'
                             ...
                             'पण्णी: आपको दुसरे खिलाड़ी के लिए \n'
                             'फिर भी अलग बटन निर्दिष्ट करने पड़ेंगे |')
    },
    'configTouchscreenWindow':{
        'actionControlScaleText':'कार्य करने के बटनों का माप',
        'actionsText':'कार्य',
        'buttonsText':'बटन',
        'dragControlsText':'< नियंत्रण बटन को पुनः स्थापित करने के लिए पकड़ के हिलाएं >',
        ...
        'swipeText':'स्वाइप',
        'titleText':'टच स्क्रीन को कॉन्फ़िगर करें'
    },
    'configureItNowText':'अभी कॉन्फ़िगर करें ?',
    'configureText':'कॉन्फ़िगर',
    'connectMobileDevicesWindow':{
        'amazonText':'अमेज़न का एप्लीकेशन भंडार',
        ...
        'bestResultsText':('सबसे अच्छे परिणामों के लये आपको विलंबन रहित नेटवर्क चाहिए होगा | \n'
                           ...
                           'राऊटर के पास खेल के, \n'
                           'व गेम मेज़बान को नेटवर्क से ईथरनेट से सीधे जोड़ के |'),
        'explanationText':('किसी स्मार्ट फ़ोन या टेबलेट का वायरलेस नयन्त्रक के रूप में प्रयोग करने के लिए \n'
                           'उसपे "${REMOTE_APP_NAME}"  एप्लीकेशन डालें | \n'
                           'कितने भी यंत्र ${APP_NAME} गेम से वाई-फी से जुड़ सकते हैं, और यह मुफ्त है !'),
        ...
        'getItForText':('${REMOTE_APP_NAME} पायें आई-ओ-एस के लिए एप्पल एप्लीकेशन भंडार से \n'
                        'व एंड्राइड के लिए गूगल प्ले भंडार या अमेज़न एप्लीकेशन भंडार से |'),
    ...
    'coopSelectWindow':{
        ...
        'activenessInfoText':('यह गुणक उन दिनों बढ़ता है जब आप खेलते हैं \n'
        ...
        'forfeitConfirmText':'यह चुनौती छोड़ दें ?',
        ...
        'pointsText':'अंक',
        'powerRankingFinishedSeasonUnrankedText':'(ख़तम किया बिना पद के)',
        ...
        'prizesText':'पुरस्कार',
        'proMultInfoText':('${PRO} उन्नयन वाले खिलाड़ियों को \n'
                           '${PERCENT}% अंकों का बढ़ावा मिलता है'),
        'seeMoreText':'और..',
        'skipWaitText':'प्रतीक्षा ख़तम करें',
        'timeRemainingText':'समय बाकी',
        'toRankedText':'अभी पद मिलना है',
        'totalText':'सम्पूर्ण',
        'tournamentInfoText':('सम्पूर्ण अंकों में अपने संघ के बाकी \n'
                              'खिलाड़ियों के साथ प्रतिस्पर्धा करें |  \n'
                              '\n'
                              'प्रतियोगिता के ख़तम होने पर सबसे ज्यादा अंकों वाले \n'
                              'खिलाड़ियों को पुरस्कार दिया जायेगा |'),
        'welcome1Text':('${LEAGUE} में आपका स्वागत है | \n'
                        'आप आपनी संघ में पैड को स्टार रेटिंग कमाने से, \n'
                        'उप्लाब्धियाँ पार करने से व  ट्रॉफी जीतने से बढ़ा सकते हैं |'),
        'welcome2Text':('आप टिकेट उन्ही गतिविधियाओं से भी कमा सकते हैं | \n'
                        'टिकेट नए रूप, नक़्शे व छोटे गेम खोलने तथा  \n'
    ...
    'creditsWindow':{
        ...
        'codingGraphicsAudioText':'कोडिंग, ग्राफ़िक्स और ध्वनि ${NAME} के द्वारा',
        ...
        'whoeverInventedCoffeeText':'जिसने भी कॉफ़ी ढूंढी!'
    },
    ...
    'debugText':'डीबग',
    'debugWindow':{
        'reloadBenchmarkBestResultsText':'टिप्पणी: इसकी जांच करते समय सेटिंग->ग्राफ़िक्स->तेक्स्चर्स को \'उच्च\' पे रखें',
        ...
        'stressTestPlayerCountText':'खिलाड़ियों कि संख्या',
    ...
    'desktopResText':'डेस्कटॉप रेज़ोल्यूशन',
    ...
    'editProfileWindow':{
        'accountProfileInfoText':('यह एक ख़ास पार्श्वचित्र ( एक नाम और आइकॉन के साथ) है \n'
        ...
        'globalProfileInfoText':('खिलाड़ियों के वैश्विक पार्श्वचित्र का अनोखा नाम होगा | \n'
                                 'वैश्विक पार्श्वचित्र वाले खिलाड़ी अपना आइकॉन भी लगा सकते हैं |'),
        'globalProfileText':'(वैश्विक पार्श्वचित्र)',
        'highlightText':'उभार',
        'iconText':'आइकॉन',
        'localProfileInfoText':('स्थानिक खिलाड़ी पार्श्वचित्र का कोई आइकॉन नहीं होता है \n'
                                'व यह भी ज़रूरी नहीं है कि उनका नाम अनोखा हो | \n'
                                'वैश्विक पार्श्वचित्र में उन्नयन करें अनोखे नाम व आइकॉन के लिए |'),
        'localProfileText':'(स्थानिक पार्श्वचित्र)',
        'nameDescriptionText':'खिलाड़ी का नाम',
        'nameText':'नाम',
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('गाने को \n'
                    'संपादित करें'),
        'fetchingITunesText':'आई-ट्यून्स कि प्लेलिस्ट ली जा रही है',
        'musicVolumeZeroWarning':'चेतावनी: गाने कि ध्वनि का स्तर ० पर है',
        'nameText':'नाम',
        ...
        'useITunesPlaylistText':'आई-ट्यून्स कि प्लेलिस्ट',
    ...
    'errorOutOfDiskSpaceText':'डिस्क पे जगह ख़तम',
    'errorText':'त्रुटी',
    ...
    'failText':'असफल',
    'fatalErrorText':('माफ़ करें कुछ लुप्त है या गड़बड़ है | \n'
    ...
    'finishingInstallText':'इनस्टॉल ख़तम हो रहा है, सब्र रखें...',
    'fireTVRemoteWarningText':('और बेहतर अनुभव के लिए \n'
                               'गेम नियंत्रक का प्रयोग करें, \n'
                               'या  \'${REMOTE_APP_NAME}\' \n'
                               'एप्लीकेशन इन्स्टाल करें अपने फ़ोन या टेबलेट पे |'),
    ...
    'gatherWindow':{
        'aboutDescriptionLocalMultiplayerExtraText':('ध्यान रखें: किसी भी यंत्र पे एक से ज्यादा खिलाड़ी हो सकते हैं \n'
        ...
        'bluetoothDescriptionText':'किसी पार्टी के मेज़बान बनें या किसी पार्टी में जुडें ब्लूटूथ से',
        'bluetoothHostText':'मेज़बान बनें ब्लूटूथ पर',
        ...
        'friendPromoCodeExpireText':'आपका कोड सिर्क नयें खिलाड़ियों के लिए चलेगा और ${EXPIRE_HOURS} घंटों के बाद काम करना बंद कर देगा',
        ...
        'googlePlayDescriptionText':'गूगल प्ले के खिलाड़ियों को अपनी पार्टी में आमंत्रण दें:',
        'googlePlayInviteText':'आमंत्रण दें',
        'googlePlayReInviteText':('आपकी पार्टी में ${COUNT} गूगल प्ले के खिलाड़ी हैं \n'
                                  'जिनका सम्बन्ध टूट जाएगा अगर आप नया आमंत्रण शुरू करते हैं |\n'
                                  ' उनको नए आमंत्रण में जोड़ें फिर से पार्टी में जोड़ने के लिए |'),
        ...
        'inDevelopmentWarningText':('टिपण्णी:  \n'
                                    ...
                                    ' कि सभी खिलाड़ी एक ही वाई-फाई नेटवर्क पे हों |'),
        ...
        'joinPublicPartyDescriptionText':'सार्वजनिक दल से जुड़ें:',
        'localNetworkDescriptionText':'अपने नेटवर्क के दल से जुड़ें:',
        ...
        'manualConnectText':'जुड़ें',
        'manualDescriptionText':'पते के द्वारा किसी दल से जुडें',
        'manualJoinableFromInternetText':'क्या आप इन्टरनेट से जुड़ सकते हैं ?:',
        ...
        'partyInviteIgnoreText':'नज़रंदाज़ करें',
        'partyInviteText':('${NAME} ने आपको अपनी पार्टी में \n'
                           'जुड़ने के लिए आमंत्रित करा है !'),
        ...
        'wifiDirectDescriptionBottomText':('यदि सारे यंत्रों में \'वाई-फाई डायरेक्ट\' का पैनल है \n'
                                           'तो यंत्र उससे आराम से एक दुसरे से जुड़ सकते हैं |\n'
                                           'जुड़ने के बाद आप \'स्थानीय नेटवर्क\' टैब से पार्टी बना सकते है, सामान्य \'वाई-फाई\' कि तरह | \n'
                                           '\n'
                                           ' सबसे अच्छे परिणामों के लिए \'वाई-फाई डायरेक्ट\' के मेज़बान को ही ${APP_NAME} पार्टी का मेज़बान होना चाहिए |'),
        'wifiDirectDescriptionTopText':('वाई-फाई डायरेक्ट\' से एंड्राइड यंत्रों को बिना वाई-फाई नेटवर्क के भी जोड़ा जा सकता है | \n'
    ...
    'getTicketsWindow':{
        ...
        'inProgressText':'एक सौदा अभी चल रहा है; कृपया थोड़ी देर बाद प्रयास करें',
        ...
        'ticketPack3Text':'बड़ा टिकेट का संग्रह',
        'ticketPack4Text':'बहुत बड़ा टिकेट का संग्रह',
        ...
        'unavailableLinkAccountText':('माफ़ करें इस प्लेटफार्म पर खरीदारी नहीं कि जा सकती है |\n'
                                      'एक वैकल्पिक हल के रूप में आप इस खाते को किसी \n'
                                      'और प्लेटफार्म के खाते से जोड़ कर खरीदारी कर सकते हैं |'),
        'unavailableTemporarilyText':'यह अभी उपलब्ध नहीं है; कृपया थोड़ी देर बाद पुनः प्रयास करें |',
        'unavailableText':'मांफ करें, यह अभी उपलब्ध नहीं है |',
        'versionTooOldText':'माफ़ कारें यह गेम का संस्करण बहुत ही पुराना है; कृपया नया संस्करण डालें',
    ...
    'graphicsSettingsWindow':{
        'alwaysText':'हमेशा',
        'fullScreenCmdText':'संपूर्ण स्क्रीन में चलायें (सी-एम्-डी + ऍफ़)',
        'fullScreenCtrlText':'संपूर्ण स्क्रीन में चलायें (सी-टी-आर-एल + ऍफ़)',
        'gammaText':'चमक',
        'highText':'ज्यादा',
        ...
        'mediumText':'ठीक ठाक',
        'neverText':'कभी नहीं',
        'resolutionText':'रेज़ोल्यूशन',
        'showFPSText':'ऍफ़-पी-एस दिखाएँ',
    ...
    'helpWindow':{
        ...
        'controllersInfoText':('आप नेटवर्क पे दोस्तों के साथ ${APP_NAME} खेल सकते हैं, या आप एक ही यंत्र पे भी खेल सकते हैं \n'
                               ...
                               'आप फ़ोन का भी नियंत्रक के रूप में प्रयोग कर सकते है मुफ्त कि \n'
        ...
        'devicesInfoText':('${APP_NAME} गेम का वी-आर संस्करण आम संस्करण के \n'
                           ...
                           'तो निकलित्ये अपने फ़ोन और टेबलेट और खेलने लग जाइए !\n'
                           'एक आम संस्करण को वी-आर संस्करण से भी जोड़ सकते हैं \n'
                           'ताकि आपके दुसरे दोस्त भी देखके मज़ा ले सकें |'),
        'devicesText':'यंत्र',
        'friendsGoodText':('इनका होना नहुत अच्छा है | ${APP_NAME} को कई खिलाड़ियों (अधिकतम ८ खिलाड़ी) \n'
                           'के साथ खेलने में मज़ा आता है |यह हमें पहुंचाता है:'),
        'friendsText':'दोस्त',
        'jumpInfoText':('- कूदें - \n'
                        'छोटे फासलें पार करने के लिए कूदें, \n'
                        'चीजों को ऊँचा फेकने के लिए कूदें, \n'
                        'और ख़ुशी ज़ाहिर करने के लिये कूदें !'),
        'orPunchingSomethingText':'या मुक्केबाजी के लिए, बहार फेकने के लिए और चिपकू बम्ब से उसे रास्ते में फोड़ने के लिए',
        'pickUpInfoText':('- उठाना - \n'
                          'झंडे, दुश्मन या कुछ भी उठायें \n'
                          'जो जमीन से न जुड़ा हो फेकने \n'
                          'के लिए फिर से दबाएँ'),
        ...
        'powerupIceBombsDescriptionText':('साधारण बम से कमज़ोर \n'
                                          'मगर दुश्मन को जमा के \n'
                                          'बहुत नाज़ुक कर देते हैं |'),
        'powerupIceBombsNameText':'बर्फ़-बम',
        'powerupImpactBombsDescriptionText':('साधारण बम से कमज़ोर \n'
        ...
        'powerupLandMinesDescriptionText':('यह एक साथ तिन मिलती हैं; \n'
                                           ...
                                           'कि सुरक्षा के लिए व तेज़ दुश्मनों को रोकने के लिए करें |'),
        'powerupLandMinesNameText':'विस्फोटक थल बम',
        'powerupPunchDescriptionText':('आपके मुक्कों को और दमदार, \n'
                                       'तेज़ और बेहतर करता है |'),
        'powerupPunchNameText':'मुक्केबाज़ी के दस्ताने',
        'powerupShieldDescriptionText':('थोडा सा नुक्सान \n'
                                        'अपने में ले लेता है |'),
        'powerupShieldNameText':'सुरक्षा कवच',
        'powerupStickyBombsDescriptionText':('जिस भी चीज़ को छुएँगे उससे चिपक जायेंगे .. \n'
                                             'इसका मज़ा लें !'),
        ...
        'punchInfoText':('- मुक्के - \n'
                         ...
                         'जितनी तेजी से मुक्के चलेंगे उतने ज़्यादा नुकसान होंगे। \n'
                         'अतः पागल जैसे दौड़ो और घूमो।'),
        'runInfoText':('- दोडें - \n'
                       'दोड़ने के लिए किसी भी बटन को दबाये रखें | \n'
                       'दोड़ने से आप जल्दी पहुँच सकते हैं लेकिन मुड़ने में दिक्कत हो सकती है, इसलिए किनारों पे सावधान रहें |'),
        'someDaysText':'कुछ दिन आपका सिर्फ मुक्के मारने का या कुछ फोड़ने का मन करता है',
    ...
    'inGameClippedNameText':('खेल में होगा \n'
                             '"${NAME}"'),
    'installDiskSpaceErrorText':('त्रुटी: इनस्टॉल ख़तम नहीं कर पाया | \n'
                                 'आपके यंत्र पे जगह ख़तम हो सकती है | \n'
    ...
    'internal':{
        ...
        'connectedToPartyText':'${NAME} कि पार्टी में जुड़ गए हैं !',
        'connectingToPartyText':'जुड़ रहे हैं ...',
        'connectionFailedHostAlreadyInPartyText':'जुड़ना असफल रहा; मेज़बान किसी और पार्टी में है |',
        'connectionFailedPartyFullText':'कनेक्शन विफल; पार्टी भरी हुई है।',
        'connectionFailedText':'जुड़ना असफल रहा |',
        'connectionFailedVersionMismatchText':('जुड़ना असफल रहा; मेज़बान गेम का अलग संस्करण चला रहा है | \n'
                                               'यह सुनिश्चित करें कि आप दोनों के पास एक ही संस्करण है और फिर प्रयास करें |'),
        'connectionRejectedText':'जुड़ने के अनुरोध को अस्वीकार कर दिया गया |',
        'controllerConnectedText':'${CONTROLLER} जुड़ गया है |',
        'controllerDetectedText':'1 नियंत्रक का पता चला है |',
        'controllerDisconnectedText':'${CONTROLLER} अब जुदा नहीं है |',
        'controllerDisconnectedTryAgainText':'${CONTROLLER} अब जुदा नहीं है | पुनः जोड़ने का प्रयास करें |',
        'controllerForMenusOnlyText':'इस नियंत्रक को खेलने के लिए इस्तेमाल नहीं किया जा सकता है; केवल मेनू नेविगेट करने के लिए।',
        'controllerReconnectedText':'${CONTROLLER} पुनः जुड़ गया है |',
        'controllersConnectedText':'${COUNT} नियंत्रक जुड़े हैं |',
        'controllersDetectedText':'${COUNT} नियंत्रक का पता चला है |',
        'controllersDisconnectedText':'${COUNT} नियंत्रक अब जुड़े नहीं है |',
        'corruptFileText':'फाइलों में कुछ गड़बड़ी है | पुनः इनस्टॉल करने का प्रयास करें या ${EMAIL} पे मेल करें',
        'errorPlayingMusicText':'${MUSIC} गाना चलने में दिक्कत',
        'errorResettingAchievementsText':'ऑनलाइन उपलब्धियों को रिसेट करने में दिक्कत; कृपया थोड़ी देर बाद पुनः प्रयास करें |',
        ...
        'incompatibleVersionHostText':('मेज़बान गेम का अलग संस्करण चला रहा है | \n'
                                       'यह सुनिश्चित करें कि आप दोनों के पास एक ही संस्करण है और फिर प्रयास करें |'),
        ...
        'joinedPartyInstructionsText':('कोई आपकी पार्टी में जुड़ गया है | \n'
        ...
        'leftPartyText':'${NAME} कि पार्टी को छोड़ दिया है |',
        'noMusicFilesInFolderText':'इस फोल्डर में कोई भी गाना नहीं है |',
        'playerJoinedPartyText':'${NAME} पार्टी में जुड़ गया है !',
        'playerLeftPartyText':'${NAME} ने पार्टी छोड़ दी है |',
        'rejectingInviteAlreadyInPartyText':'आमंत्रण को अस्वीकार किया जा रहा है (पहले से ही पार्टी में हैं) |',
        'serverRestartingText':'पुन: प्रारंभ हो रहा है। कृपया एक पल में फिर से जुड़ें...',
        ...
        'timeOutText':'(समय ख़तम होने में ${TIME} सेकंड)',
        'touchScreenJoinWarningText':('आपने टच स्क्रीन से जोड़ा है | \n'
                                      'अगर यह गलती से हुआ है तो \'मेनू -> गेम छोड़ें\' से बाहर निकल जाएँ |'),
        ...
        'willTimeOutText':'(समय ख़तम हो जायेगा अगर आलसी रहेंगे)'
    },
    'jumpBoldText':'कूदें',
    'jumpText':'कूदें',
    'keepText':'रखें',
    ...
    'league':{
        ...
        'currentSeasonText':'वर्तमान सीज़न (${NUMBER})',
        'leagueFullText':'${NAME} संघ',
        'leagueRankText':'संघ में पद',
        'leagueText':'संघ',
        'rankInLeagueText':'#${RANK}, ${NAME} संघ ${SUFFIX}',
        'seasonEndedDaysAgoText':'सीज़न ख़तम हो गया ${NUMBER} दिन पहले |',
        'seasonEndsDaysText':'सीज़न ख़तम होगा ${NUMBER} दिनों में |',
        'seasonEndsHoursText':'सीज़न ख़तम होगा ${NUMBER} घंटों में |',
        'seasonEndsMinutesText':'सीज़न ख़तम होगा ${NUMBER} मिनटों में |',
        'seasonText':'सीज़न संख्या ${NUMBER}',
        'tournamentLeagueText':'इस प्रतियोगिता में हिस्सा लेने के लिए आपको ${NAME} संघ तक पहले पहुंचना होगा',
        'trophyCountsResetText':'ट्रॉफी कि संख्या अगले सीज़न में रिसेट हो जायेगी'
    },
    'levelBestScoresText':'${LEVEL} पर सर्वश्रेष्ठ स्कोर',
    'levelBestTimesText':'${LEVEL} पर सबसे अच्छे समय',
    'levelFastestTimesText':'सबसे तेज़ ${LEVEL} स्तर पे',
    ...
    'mainMenu':{
        ...
        'endGameText':'गेम ख़तम करें',
        'exitGameText':'गेम से बहार जाएँ',
        'exitToMenuText':'ख़तम कर के मेनू में जाएं ?',
        'howToPlayText':'कैसे खेलें',
        'justPlayerText':'(केवल ${NAME})',
        'leaveGameText':'गेम छोड़ें',
        'leavePartyConfirmText':'सही में पार्टी छोड़ें ?',
        'leavePartyText':'पार्टी छोड़ें',
        'quitText':'बंद कर दें',
        'resumeText':'पुनः शुरू करें',
        'settingsText':'सेटिंग'
    },
    'makeItSoText':'लागू करें',
    'mapSelectGetMoreMapsText':'और नक़्शे पायें....',
    'mapSelectText':'चुनें....',
    'mapSelectTitleText':'${GAME} नक़्शे',
    'mapText':'नक्शा',
    'maxConnectionsText':'अधिकतम कनेक्शन',
    'maxPartySizeText':'अधिकतम पार्टी का आकार',
    'maxPlayersText':'अधिकतम खिलाड़ी',
    'mostValuablePlayerText':'सबसे ज्यादा कीमती खिलाड़ी',
    'mostViolatedPlayerText':'सबसे ज्यादा उल्लंघित खिलाड़ी',
    'mostViolentPlayerText':'सबसे ज्यादा हिंसात्मक खिलाड़ी',
    'moveText':'हिलें',
    'multiKillText':'${COUNT}-हत्याएं!!!',
    'multiPlayerCountText':'${COUNT} खिलाड़ी',
    'mustInviteFriendsText':('टिपण्णी: आपको अपने दोस्तों को आमंत्रण \n'
                             'भेजना होगा "${GATHER}" पैनल में, \n'
                             'या दोस्तों के साथ खेलने के लिए नियंत्रक जोड़ें |'),
    ...
    'noProfilesErrorText':('आपकी कोई खिलाड़ी पार्श्वचित्र नहीं है, इसलिए आप \'${NAME}\' नाम के साथ फंसे हैं |\n'
                           'सेटिंग -> खिलाड़ी पार्श्वचित्र में जाके अपने लिए पार्श्वचित्र बनायें |'),
    ...
    'notEnoughPlayersRemainingText':'पर्याप्त खिलाड़ी बाकी नहीं हैं; बंद कर के नया गेम शुरू करें |',
    'notEnoughPlayersText':'आपको कम से कम ${COUNT} खिलाड़ी चाहिए गेम शुरू करने के लिए !',
    'notNowText':'अभी नहीं',
    'notSignedInErrorText':'यह करने के लिए आपको अपने खाते में साइन इन करना पड़ेगा',
    'notSignedInGooglePlayErrorText':'आपको गूगल प्ले से साइन इन करना पड़ेगा यह करने के लिए |',
    ...
    'partyWindow':{
        'chatMessageText':'गपशप ख़त',
        'emptyText':'आपकी पार्टी खाली है',
        'hostText':'(मेज़बान)',
        'sendText':'भेजें',
        'titleText':'आपकी पार्टी'
    },
    'pausedByHostText':'(मेज़बान ने रोका है)',
    'perfectWaveText':'निष्कलंक लहर !',
    'pickUpText':'उठायें',
    'playModes':{
        'coopText':'एक साथ',
        'freeForAllText':'सभी-के-लिए',
    ...
    'playText':'खेलें',
    'playWindow':{
        'oneToFourPlayersText':'१-४ खिलाड़ी',
        'titleText':'खेलें',
        'twoToEightPlayersText':'२-८ खिलाड़ी'
    },
    'playerCountAbbreviatedText':'${COUNT} व्यक्ति',
    'playerDelayedJoinText':'${PLAYER} अगले दौर कि शुरुआत में आएगा।',
    'playerInfoText':'खिलाड़ी कि जानकारी',
    'playerLeftText':'${PLAYER} ने गेम छोड़ दिया है',
    'playerLimitReachedText':'खिलाड़ी कि अधिकतम संख्या ${COUNT} तक पहुँच गयी है; कोई और अब नहीं जुड़ सकता है |',
    'playerProfilesWindow':{
        ...
        'newButtonText':('नया \n'
                         'पार्श्वचित्र'),
        'titleText':'खिलाड़ी के पार्श्वचित्र'
    },
    'playerText':'खिलाड़ी',
    ...
    'pleaseRateText':('अगर आपको ${APP_NAME} में मज़ा आ रहा है, \n'
    ...
    'pressJumpToFlyText':'** उड़ने के लिए कूदने वाला बटन बार बार दबाएँ **',
    'pressPunchToJoinText':'जुड़ने के लिए मुक्के वाला बटन दबाएँ...',
    ...
    'ps3ControllersWindow':{
        'macInstructionsText':('अपने पी.एस.३ के पीछे कि बिजली को काटें, \n'
                               ...
                               'फिर अपने नियंत्रक को अपने मैक से जोड़ें एक यु.एस.बी तार से | \n'
                               'इसके बाद से आप अपने नियंत्रक के होम बटन से मैक से जुड़ सकते है दोनों तार के साथ और \n'
                               ...
                               '\n'
                               '\n'
                               'पी.एस.३ के नियंत्रक जो बिना तार के जुड़े हैं वोह यंत्रों कि सूचि में दिखने चाहिए | \n'
                               'आपको उन्हें हटाना पड़ सकता है उस सूचि से जब \n'
                               'आपको उनका पुनः पी.एस.३ के साथ प्रयोग करना हो |  \n'
                               '\n'
                               'और यह भी ध्यान रखें कि जब वोह प्रयोग में ना हों तो \n'
                               'वोह जुड़े ना हों अन्यथा उनकी बैटरी ख़तम होती रहेगी |  \n'
                               '\n'
                               'ब्लूटूथ पे अधिकतम ७ यंत्र चल जाने चाहिए, \n'
                               'हालाकि उनमें थोड़ी देरी आ सकती है |'),
        'ouyaInstructionsText':('पी.एस.३ नियंत्रक को ऊया के सस्थ चलने के लिए सिर्फ उसे एक बार यु.एस.बी तार से जोड़ दें |\n'
                                'यह करने पे आपके बाकी नियंत्रकों का जोड़ टूट सकता है इसलिए आपको अपने ऊया को पुनः शुरू\n'
                                'कर के यु.एस.बी तार निकाल देना चाहिए |  \n'
                                '\n'
                                'इसके बाद से आप नियंत्रक का \'होम\' बटन दबा के बिना तार के जुड़ सकते हैं | \n'
                                'जब आपका खेलना ख़तम हो जाए तो \n'
                                '\'होम\' बटन १० सेकंड तक दबा के \n'
                                'नियंत्रक को बंद कर दें अन्यथा वोह बैटरी ख़तम कर सकता है |'),
        'pairingTutorialText':'शैक्षणिक वीडियो जोड़ा जा रहा है',
    ...
    'randomPlayerNamesText':'किशोर, यश, ख्याति, शालिनी, आदित्य, उमेस, निश्चिंत, भाविक, रिशव, तुषार, राहुल, अमोल, मिशेल, प्रियंका, कल्याण, रियान, दिविज, हरी, आदर्श, कौस्तुभ, ज़ोया, सीनू, प्रतीक, ज़ारा, रुक्सार, शकील, पूजा, शबनम, शेरा, चेतन, समीर, टोनी, अजय, आकाश, पंकज, आरती, शबाना, मुमताज़, शुभम, शिवम्, लकेव, सचिन, दीपक, अक्षय, अर्जुन, किशन, राधा, विश्वनाथ, शालू, विमल, शिवा, पप्पू, नरेंद्र, आज़म, अनमोल, काजल, संध्या, दिनेश, प्रिंस, आनंद, अज़हर, पवन, अभिषेक, विवेक',
    'randomText':'अनियमित',
    'rankText':'पद',
    ...
    'remote_app':{
        ...
        'cant_resolve_host':'मेज़बान से जुड़ नहीं पा रहे...',
        'capturing':'पकड़ा जा रहा है...',
        'connected':'जुड़ गए हैं',
        'description':('अपने फ़ोन या टेबलेट का नियंत्रिक के रूप में बोम्ब-स्क्वाड के लिए प्रयोग करें |  \n'
                       'अधिकतम ८ यंत्र जुड़ सकते है एक साथ एक ही टेबलेट या दूरदर्शन में अपना अलग अलग खेलने के लिए |'),
        ...
        'searching_caption':('जुड़ने के लिए किसी गेम के नाम को दबाएँ | \n'
    ...
    'replayVersionErrorText':('माफ़ करें, यह रीप्ले किसी और संस्करण में बना था  \n'
    ...
    'replaysText':'रीप्ले',
    'reportPlayerExplanationText':('इस ईमेल का प्रयोग करके धोकाधड़ी या अनुचित शब्दों के प्रयोग या \n'
                                   'किसी और चीज़ कि आख्या दें | कृपया निचे विवरण दीजिये :'),
    'reportThisPlayerCheatingText':'धोकाधड़ी',
    ...
    'settingsWindowAdvanced':{
        ...
        'mustRestartText':'इसके लागू होने के लिए आपको गेम को पुनः शुरू करना पड़ेगा |',
        'netTestingText':'नेटवर्क पर परीक्षण',
        'resetText':'रीसेट',
        'showBombTrajectoriesText':'बोम्ब का पथ दिखाएँ',
        'showPlayerNamesText':'खिलाड़ी का नाम दिखाएँ',
    ...
    'translations':{
        ...
        'gameDescriptions':{
            ...
            'Carry the flag for ${ARG1} seconds.':'${ARG1} सेकंड के लिए ध्वज पकड़ें',
            ...
            'Run ${ARG1} laps.':'${ARG1} अंतराल दौड़ेँ',
            'Run ${ARG1} laps. Your entire team has to finish.':'${ARG1} अंतराल दौड़ेँ। आपकी पूरी टीम को खत्म करना है।',
            'Run 1 lap.':'1 अंतराल दौड़ो।',
            'Run 1 lap. Your entire team has to finish.':'१ अंतराल दौड़ेँ। आपकी पूरी टीम को भी दौड़ना है।',
        ...
        'serverResponses':{
            ...
            'Account linking successful!':'खाता का जुड़ाव सफल!',
            ...
            ('Are you sure you want to link these accounts?\n'
             ...
             '${ACCOUNT2}\n'
             '\n'
             'This cannot be undone!'):('क्या आप वाकई इन खातों को जोड़ना चाहते हैं?  \n'
                                        '\n'
                                        '${ACCOUNT1} \n'
                                        '${ACCOUNT2}  \n'
                                        '\n'
            ...
            'Can\'t link; would surpass maximum of ${COUNT} linked accounts.':'लिंक नहीं किआ जा सकता; अधिकतम ${COUNT} खातों का जुड़ाव पार होने की सम्भावना है।',
            ...
            ('LINKING DENIED. ${ACCOUNT} contains\n'
             ...
             '(and lose THIS account\'s data instead)'):('जुड़ाव अस्वीकृत। ${ACCOUNT} में  महत्वपूर्ण डेटा शामिल है \n'
        ...
        'statements':{
            '${TEAM} is disqualified because ${PLAYER} left':'${TEAM} अयोग्य है क्योंकि ${PLAYER} ने छोड़ दिया।',
            'Killing ${NAME} for skipping part of the track!':'रास्ते के कुछ भाग छोड़ने के लिए ${NAME} को मृत्यु दंड !',
        ...
        'tips':{
            ('A perfectly timed running-jumping-spin-punch can kill in a single hit\n'
             'and earn you lifelong respect from your friends.'):('एक परिपूर्ण समय से किआ गया दौड़-कूद-स्पिन-पंच एक ही बार में मार सकता है\n'
            ...
            'Hold any button to run.  (Trigger buttons work well if you have them)':'दौड़ने के लिए कोई भी बटन दबाए रखें। (यदि आपके पास है तो ट्रिगर बटन अच्छी तरह से काम करते हैं)',
            ('Hold down any button to run. You\'ll get places faster\n'
             'but won\'t turn very well, so watch out for cliffs.'):('दौड़ने के लिए किसी भी बटन को दबाए रखें। आप स्थानों को तेजी से प्राप्त करेंगे\n'
                                                                     'लेकिन बहुत अच्छी तरह से नहीं मुड़ पाएंगे, तो चट्टानों ज़रा संभल कर ।'),
            ...
            'In hockey, you\'ll maintain more speed if you turn gradually.':'हॉकी में, यदि आप धीरे-धीरे मुड़ते हैं तो आप अधिक गति बनाए रखेंगे।',
    ...
    'tutorial':{
        ...
        'phrase10Text':'दौड़ना से भी मदद मिलती है।',
        'phrase11Text':'दौड़ने के लिए किसी भी को बटन दबाए रखें।',
        ...
        'phrase20Text':'ज़्यादा दूर फेकने के लिए बम को "घुमा" कर फेकें।',
        ...
        'skipConfirmText':'सच में ट्यूटोरियल छोड़ना चाहते हैं? पुष्टि करने के लिए स्पर्श करें या दबाएं।',
        'skipVoteCountText':'${COUNT}/${TOTAL} मतदान छोड़ना',
        'skippingText':'शिक्षण छोड़ा जा रहा है...',
    ...
    'usingItunesText':'साउंडट्रैक के लिए आईट्यून्स का उपयोग ...',
