...
values = {
    'accountSettingsWindow':{
        'accountNameRules':'اسم نمیتواند اموجی(شکلک) و حروف ویژه داشته باشد',
        'accountProfileText':'(مشخصات حساب)',
        'accountsText':'حساب‌ها',
        'achievementProgressText':'دستاوردها: ${COUNTS} از ${TOTAL}',
        'campaignProgressText':'پیشرفت در بازی اصلی (سخت) : ${PROGRESS}',
        'changeOncePerSeason':'شما این را می توانید یکبار در هر فصل تغییر دهید',
        'changeOncePerSeasonError':'(روز تا فصل بعد ${NUM}) برای تغییر این گزینه باید تا فصل بعد صبر کنید',
        'customName':'نام کاربری',
        'linkAccountsEnterCodeText':'کد را وارد کنید',
        'linkAccountsGenerateCodeText':'ایجاد کد',
        'linkAccountsInfoText':'(به اشتراک گذاری پیشرفت بین دستگاه‌های مختلف)',
        'linkAccountsInstructionsNewText':('برای اتصال دو حساب کاربری، ابتدا یک کد در حساب اول بسازید\n'
                                           ...
                                           'اطلاعات حساب دوم بین دو حساب به اشتراک گذاشته می شوند.\n'
                                           '(اطلاعات حساب اول از بین خواهد رفت!!)\n'
                                           '\n'
                                           'شما می توانید ${COUNT} حساب را به هم متصل کنید.\n'
                                           '\n'
                                           'تذکر مهم: تنها حساب هایی که متعلق به خودتان است به هم متصل کنید!\n'
                                           'اگر شما به حساب دوست‌تان متصل شوید،\n'
                                           ' نمی‌توانید همزمان آنلاین بازی کنید.'),
        ...
        'nameChangeConfirm':'ایا اسم شما${NAME}باشد؟',
        'resetProgressConfirmNoAchievementsText':('همه ی پیشرفت شما در بخش همکاری و بالاترین امتیازات شما پاک خواهد شد.\n'
                                                  '(به استثنای بلیط های شما)\n'
                                                  'این تغییرات خنثی نخواهد شد ، آیا مطمئنید ؟'),
        'resetProgressConfirmText':('تمام پیشرفت‌ها در بخش همکاری ، دستاوردها\n'
                                    'و امتیازات بالای شما پاک خواهد شد.\n'
                                    '(به استثنای بلیط‌های شما)\n'
                                    'این کار برگشت‌ناپذیر است. آیا مطمئنید ؟'),
        'resetProgressText':'پاک کردن پیشرفت',
        'setAccountName':'تنظیم نام حساب',
        'setAccountNameDesc':('اسمی که میخواهید برای این حساب نمایش داده شود را انتخاب کنید\n'
                              'شما میتوانید یکی از اسم های حساب های وصل شده استفاده کنید \n'
                              'یا یک اسم جدید بسازید'),
        'signInInfoText':('به حساب خود وصل شوید تا بلیط جمع کنید ، آنلاین رقابت کنید \n'
                          'و پیشرفت خود را با بقیه به اشتراک بگذارید'),
        'signInText':'ورود به حساب',
        'signInWithDeviceInfoText':'(یک حساب اتوماتیک فقط از این دستگاه در دسترس میباشد)',
        'signInWithDeviceText':'وصل شدن با حساب دستگاه',
        'signInWithGameCircleText':'وصل شدن از طریق حوزه ی بازی',
        'signInWithGooglePlayText':'ورود با حساب گوگل',
        'signInWithTestAccountInfoText':'(اکانت میراثی؛ از حساب های قدیمی استفاده میشود)',
        ...
        'ticketsText':'بلیط ها : ${COUNT}',
        'titleText':'حساب',
        'unlinkAccountsInstructionsText':'یک حساب را برای جداسازی انتخاب کنید',
        'unlinkAccountsText':'جداسازی اکانت ها',
        'viaAccount':'(${NAME} از طریق حساب)',
        'youAreSignedInAsText':'با این عنوان وصل شده اید :'
    },
    'achievementChallengesText':'چالش ها برای کسب دستاورد',
    'achievementText':'دستاورد',
    'achievements':{
        'Boom Goes the Dynamite':{
            'description':'. نابود کن TNT سه حریف را با',
            'descriptionComplete':'! نابود کردی TNT سه حریف را با',
            'descriptionFull':'را با تی ان تی از بین ببر ${LEVEL} سه حریف در سطح',
            'descriptionFullComplete':'را با تی ان تی از بین بردی ${LEVEL} سه حریف در سطح',
            'name':'!ترکوندی'
        },
        'Boxer':{
            'description':'بدون استفاده از هیچ نوع بمبی برنده شو',
            'descriptionComplete':'بدون استفاده از بمب، برنده شد',
            'descriptionFull':'را بدون استفاده از هیچ نوع بمبی تمام کن ${LEVEL} مرحله',
            'descriptionFullComplete':'را بدون استفاده از بمب تمام کردی ${LEVEL} مرحله',
            'name':'بوکسر'
        },
        'Dual Wielding':{
            'descriptionFull':'(دو دسته ی بازی وصل کن(سخت افزاری یا نرم افزاری',
            'descriptionFullComplete':'(دو دسته ی بازی وصل کردی(سخت افزار یا نرم افزار',
            'name':'دوگانه اداره کردن'
        },
        'Flawless Victory':{
            'description':'بدون ضربه خوردن برنده شو',
            'descriptionComplete':'بدون ضربه خوردن برنده شدی',
            'descriptionFull':'را بدون ضربه خوردن برنده شو ${LEVEL} مرحله',
            'descriptionFullComplete':'را بدون ضربه خوردن برنده شدی ${LEVEL} مرحله',
            'name':'پیروزی بی عیب و نقص'
        },
        'Free Loader':{
            'descriptionFull':'یک بازی به سبک تک به تک را با دو بازیکن یا بیشتر شروع کن',
            'descriptionFullComplete':'یک بازی تک به تک را با دو نفر یا بیشتر شروع کردی',
            'name':'بارگذار رایگان'
        },
        'Gold Miner':{
            'description':'شش حریف را با مین زمینی نابود کن',
            'descriptionComplete':'شش حریف را با مین زمینی نابود کردی',
            'descriptionFull':'شش حریف را در مرحله ${LEVEL}.با مین زمینی از بین ببر',
            'descriptionFullComplete':'با مین زمینی نابود کردی ${LEVEL} شش حریف را در مرحله',
            'name':'مین‌گذار حرفه‌ای'
        },
        'Got the Moves':{
            'description':'پیروز شدن بدون استفاده از مشت  یا بمب',
            'descriptionComplete':'.بدون استفاده از هیچ گونه مشت یا بمبی برنده شدی',
            'descriptionFull':'را بدون مشت یا بمب برنده شو  ${LEVEL} مرحله',
            'descriptionFullComplete':'را بدون مشت یا بمب برنده شدی ${LEVEL} مرحله',
            'name':'عجب حرکتی'
        },
        'In Control':{
            'descriptionFull':'(یک دسته ی بازی وصل کن(سخت افزاری یا نرم افزاری',
            'descriptionFullComplete':'(یک دسته ی بازی وصل کردی(سخت افزار یا نرم افزار',
            'name':'تحت کنترل'
        },
        'Last Stand God':{
            'description':'هزار امتیاز بگیر',
            'descriptionComplete':'هزار امتیاز گرفتی',
            'descriptionFull':'هزار امتیاز بگیر ${LEVEL}در مرحله ی',
            'descriptionFullComplete':'هزار امتیاز گرفتی ${LEVEL}در مرحله ی',
            'name':'${LEVEL} سَرور'
        },
        'Last Stand Master':{
            'description':'بگیر ۲۵۰امتیاز',
            'descriptionComplete':'گرفتی۲۵۰امتیاز',
            'descriptionFull':'دویست و پنجاه امتیاز بگیر ${LEVEL}در مرحله ی',
            'descriptionFullComplete':'دویست و پنجاه امتیاز گرفتی${LEVEL}در مرحله ی',
            'name':'${LEVEL} استاد'
        },
        'Last Stand Wizard':{
            'description':'پونصد امتیاز بگیر',
            'descriptionComplete':'پونصد امتیاز گرفتی',
            'descriptionFull':'پونصد امتیاز بگیر ${LEVEL}در مرحله ی',
            'descriptionFullComplete':'پونصد امتیاز گرفتی${LEVEL}در مرحله ی',
            'name':'${LEVEL} جادوگر'
        },
        'Mine Games':{
            'description':'سه حریف را با مین زمینی از بین ببر',
            'descriptionComplete':'سه حریف را با مین زمینی از بین بردی',
            'descriptionFull':'با مین ببر${LEVEL}سه حریف را در مرحله ی',
            'descriptionFullComplete':'با مین از بین بردی${LEVEL}سه حریف را در مرحله ی',
            'name':'بازی با مین'
        },
        'Off You Go Then':{
        ...
        'Pro Football Shutout':{
            'description':'.بدون اجازه دادن به حریف که امتیاز بگیرد برنده شو.',
            'descriptionComplete':'.بدون اجازه دادن به حریف که امتیاز بگیرد برنده شدی',
    ...
    'connectMobileDevicesWindow':{
        ...
        'forIOSText':'iOS برای',
        'getItForText':('بگیرید فروشگاه برنامه اپل را برای اپلی‌ها از ${REMOTE_APP_NAME} برنامه\n'
    ...
    'coopSelectWindow':{
        ...
        'activenessInfoText':('این افزاینده امتیاز بیشتر می‌شود در روزهایی که\n'
                              'بازی میکنید و در روزهایی که بازی نمی‌کنید'),
        'activityText':'فعالیت',
        'campaignText':'عملیات',
    ...
    'debugWindow':{
        ...
        'runCPUBenchmarkText':'را بسنجیدCPUعملکرد',
        'runGPUBenchmarkText':'را بسنجیدGPUعملکرد',
        ...
        'titleText':'سنجش ها و تست های استرس',
    ...
    'editProfileWindow':{
        'accountProfileInfoText':('این پروفایل ویژه دارای یک نام\n'
                                  '.و تندیس بر اساس حسابتان است\n'
                                  '\n'
                                  '${ICONS}\n'
                                  '\n'
                                  'پروفایل های سفارشی بسازید تا از نام ها\n'
                                  '.و تندیس های مختلف استفاده کرده باشید'),
        'accountProfileText':'(پروفایل حساب)',
        ...
        'globalProfileInfoText':('ضمانت میشود که پروفایل های جهانی بازیکنان نام های\n'
                                 'یکتا دارند. همچنین به ضمیمه یک تندیس سفارشی'),
        'globalProfileText':'(پروفایل جهانی)',
        'highlightText':'بخش درخشان',
        'iconText':'تندیس',
        'localProfileInfoText':('پروفایل های محلی بازیکنان تندیس ندارند و ضمانت نمیشود\n'
                                'که نام آن ها یکتا باشد. پروفایل را جهانی کنید تا\n'
                                '.نامی یکتا و تندیسی سفارشی داشته باشد'),
        'localProfileText':'(پروفایل محلی)',
        'nameDescriptionText':'نام بازیکن',
        'nameText':'نام',
        'randomText':'تصادفی',
        'titleEditText':'ویرایش پروفایل',
        'titleNewText':'پروفایل جدید',
        ...
        'upgradeToGlobalProfileText':'ارتقا دادن به پروفایل جهانی'
    },
    'editSoundtrackWindow':{
        ...
        'editText':('ویرایش\n'
                    'صدا'),
        'fetchingITunesText':'گرفتن صدا از لیست‌پخش آیتونز...',
        ...
        'useITunesPlaylistText':'iTunes لیست موسیقی',
    ...
    'endText':'پایان',
    'enjoyText':'لذت ببرید',
    'epicDescriptionFilterText':'در حماسه ی حرکت آهسته ${DESCRIPTION}',
    'epicNameFilterText':'${NAME} حماسه',
    ...
    'gatherWindow':{
        ...
        'hostPublicPartyDescriptionText':'میزبانی یک گروه عمومی',
        ...
        'joinPublicPartyDescriptionText':'پیوستن به بازیهای عمومی',
        'localNetworkDescriptionText':':به یک گروه در شبکه ی خود متصل شوید',
    ...
    'internal':{
        ...
        'controllerDetectedText':'یک کنترولر شناسایی شد',
        ...
        'controllerForMenusOnlyText':'این کنترولر نمیتونه مورد استفاده قرار بگیره در بازی',
        ...
        'serverRestartingText':'.شروع مجدد.لطفا چند لحظه دیگر مجدد متصل شوید',
    ...
    'languageSetText':'است "${LANGUAGE}" زبان حالا',
    'lapNumberText':'Lap ${CURRENT}/${TOTAL}',
    'lastGamesText':'(آخرین ${COUNT} بازی)',
    'leaderboardsText':'مدیران',
    'league':{
        'allTimeText':'همیشه',
        'currentSeasonText':'فصل جاری (${NUMBER})',
    ...
    'levelIsLockedText':'${LEVEL} قفله',
    'levelMustBeCompletedFirstText':'ابتدا باید تکمیل شود ${LEVEL}',
    'levelText':'${NUMBER} مرحله',
    'levelUnlockedText':'!قفل مرحله باز شد',
    'livesBonusText':'پاداش تعداد جان ها',
    'loadingText':'در حال بارگزاری',
    'loadingTryAgainText':'لطفا صبر کنید؛ چند لحظه دیگر دوباره امتحان کنید',
    ...
    'nameDiedText':'${NAME} از بین رفت',
    'nameKilledText':'${NAME} ازبین برد ${VICTIM} رو',
    'nameNotEmptyText':'!قسمت نام نمیتونه خالی بمونه',
    'nameScoresText':'${NAME} موفق شد',
    'nameSuicideKidFriendlyText':'${NAME} بیرون افتاد',
    'nameSuicideText':'${NAME} بیرون افتاد',
    'nameText':'اسم',
    'nativeText':'بومی',
    'newPersonalBestText':'!رکورد قبلیتو شکستی',
    'newTestBuildAvailableText':('تست جدید ساخته شده در دسترس است! (${VERSION} ساختن ${BUILD}).\n'
                                 'در مسیر ${ADDRESS}'),
    'newText':'جدید',
    'newVersionAvailableText':'(${VERSION})در دسترس است${APP_NAME}یک نسخه جدید تر',
    ...
    'notEnoughPlayersText':'شما برای شروع بازی نیاز دارید به حداقل ${COUNT} بازیکن!',
    'notNowText':'حالا نه',
    ...
    'playerLeftText':'.بازی را ترک کرد ${PLAYER} بازیکن',
    'playerLimitReachedText':'محدودیت بازکن به ${COUNT} رسیده; عضو جدید مجاز نیست.',
    'playerProfilesWindow':{
        'cantDeleteAccountProfileText':'شما نمی‌توانبد پروفایل مربوط به حساب‌کاربری را حذف کنید.',
        ...
        'newButtonText':('پروفایل\n'
                         'جدید'),
        'titleText':'پروفایل بازیکنان'
    },
    'playerText':'بازیکن',
    ...
    'pleaseRateText':('If you\'re enjoying ${APP_NAME}, please consider taking a\n'
                      ...
                      'thanks!\n'
                      '-eric'),
    'pleaseWaitText':'...لطفا صبر کنید',
    'practiceText':'تمرین',
    'pressAnyButtonPlayAgainText':'فشار یک دکمه برای بازی مجدد ...',
    'pressAnyButtonText':'فشار هر دکمه‌ای برای ادامه',
    'pressAnyButtonToJoinText':'پیوستن با فشار هر دکمه‌ای...',
    'pressAnyKeyButtonPlayAgainText':'فشار هر دکمه ای برای انجام بازی دوباره',
    'pressAnyKeyButtonText':'فشار هر دکمه ای برای ادامه دادن',
    'pressAnyKeyText':'یک کلید را فشار دهید ...',
    'pressJumpToFlyText':'**پرواز با زدن مرتب دکمه پرش**',
    'pressPunchToJoinText':'برای پیوستن به بازی ، دکمه ی مشت را بزنید',
    ...
    'promoSubmitErrorText':'خطا در ارسال کد،لطفا اتصال اینترنت را بررسی کنید',
    'ps3ControllersWindow':{
        ...
        'titleText':'استفاده از کنترولر پی‌اس3 در بازی ${APP_NAME}:'
    },
    'punchBoldText':'مشت',
    'punchText':'مشت',
    ...
    'quittingIn5SecondsText':'ترک در پنج ثانیه',
    ...
    'removeInGameAdsText':'بازی را در فروشگاه بخرید تا تبلیغات حذف شود "${PRO}" نسخه ی',
    ...
    'settingsWindow':{
        ...
        'advancedText':'پیشرفته',
        'audioText':'صدا',
        'controllersText':'کنترول کننده‌ها',
        'graphicsText':'تصویر',
        'playerProfilesMovedText':'توجه: مشخصات بازیکن به پنجره حساب در منوی اصلی نقل مکان کرد.',
        'titleText':'تنظیمات'
    },
    'settingsWindowAdvanced':{
        'alwaysUseInternalKeyboardDescriptionText':'(ساده، کنترل پسند بر روی صفحه نمایش صفحه کلید برای ویرایش متن)',
        ...
        'showUserModsText':'نمایش پوشه سبک بازی‌ها',
        'titleText':'پیشرفته',
        ...
        'translationInformMe':'به من اطلاع بده وقتی بروزرسانی جدیدی برای زبان موجود است',
        'translationNoUpdateNeededText':'زبان کنونی به روز است',
    ...
    'store':{
        ...
        'howToUseIconsText':'ایجاد پروفایل های جهانی از قسمت پنجره ی حساب برای استفاده در این مورد',
    ...
    'translations':{
        ...
        'serverResponses':{
            ...
            'An error has occurred; please contact support@froemling.net.':'خطایی رخ داده است؛ لطفا با support@froemling.net تماس بگیرید',
            'An error has occurred; please try again later.':'اشتباهی رخ داده ؛ لطفا بعدا تلاش کنید',
            ('Are you sure you want to link these accounts?\n'
             '\n'
             '${ACCOUNT1}\n'
             '${ACCOUNT2}\n'
             '\n'
             'This cannot be undone!'):('آیا مطمین هستید که میخواید این حساب بسته بشه؟\n'
                                        '\n'
                                        '${ACCOUNT1}\n'
                                        '${ACCOUNT2}\n'
                                        '\n'
                                        'این قابل بازگشت نیست'),
            'BombSquad Pro unlocked!':'! نسخه ی حرفه ای فعال شد',
            'Can\'t link 2 accounts of this type.':'نمی‌تواند دو حساب از این نوع را پیوند داد.',
            ...
            ('Link account ${ACCOUNT} to this account?\n'
             ...
             'This can not be undone.  Are you sure?'):('آیا مایلید که حساب کاربری ${ACCOUNT} را به حساب خودتان متصل کنید؟\n'
                                                        'تمام اطلاعات روی حساب ${ACCOUNT} از بین خواهد رفت.\n'
                                                        'این کار قابل بازگشت نیست. آیا مطمئنید؟'),
            'Max number of playlists reached.':'تعداد بازی ها به حداکثر رسیده است',
            'Max number of profiles reached.':'تعداد پروفایل به حداکثر رسیده است',
            'Maximum friend code rewards reached.':'.حداکثر جایزه کد ارسالی برای دوستان دریافت شد',
            'Profile "${NAME}" upgraded successfully.':'با موفقیت ارتقا یافت "${NAME}" پروفایل',
            'Profile could not be upgraded.':'پرفایل نمیتواند ارتقا یابد',
        ...
        'tips':{
            ...
            ('Create player profiles for yourself and your friends with\n'
             'your preferred names and appearances instead of using random ones.'):('برای خودت و کسانی که باهاشون بازی می کنی پروفایل بساز تا\n'
                                                                                    ' مجبور نشی از بازیکنان تصادفی خود بازی استفاده کنی'),
    ...
    'usingItunesText':'استفاده از آیتونز برای موسیقی متن',
    ...
    'watchWindow':{
        ...
        'deleteReplayButtonText':('حذف\n'
                                  'بازبخش'),
        'myReplaysText':'بازیهای ضبط شده‌ی من',
