...
values = {
    ...
    'disableXInputDescriptionText':('Povolí více než 4 ovladače ale nemusí\n'
                                    'fingovat dobře.'),
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('Upravit\n'
                    'Soundtrack'),
        'fetchingITunesText':'získávám playlist iTunes...',
        ...
        'useITunesPlaylistText':'Playlist iTunes',
    ...
    'failText':'Fail',
    'fatalErrorText':('Ou nou,něco chybí nebo se něco rozbilo.\n'
    ...
    'gatherWindow':{
        ...
        'hostPublicPartyDescriptionText':'Hostovat Public Party',
        ...
        'joinPublicPartyDescriptionText':'Přidat se k Public Party',
        'localNetworkDescriptionText':'Připojit se k partě ve Vaší síti:',
    ...
    'internal':{
        ...
        'serverRestartingText':'RESTARTOVÁNÍ. Prosím, vráť se za chvíli ...',
    ...
    'nameBetrayedText':'${NAME} zdradil ${VICTIM}',
    ...
    'translations':{
        ...
        'coopLevelNames':{
            ...
            'Uber ${GAME}':'${GAME} - Über',
            'Uber Football':'Ragby - Übertěžké',
            'Uber Onslaught':'Útok - Übertěžké',
            'Uber Runaround':'Obrana - Übertěžká'
        },
        'gameDescriptions':{
    ...
    'usingItunesText':'Používám iTunes na soundtrack...',
