...
values = {
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('Επεξεργασία\n'
                    'Πακέτου'),
        'fetchingITunesText':'μεταφορά λιστών μουσικής των iTunes...',
        ...
        'useITunesPlaylistText':'Λίστα Μουσικής iTunes',
    ...
    'internal':{
        ...
        'serverRestartingText':'ΕΠΑΝΕΚΚΙΝΗΣΗ. Μιά στιγμή. Παρακαλώ επανενταχθείτε ξανά...',
    ...
    'usingItunesText':'Χρήση iTunes για ηχητική υπόκρουση...',
