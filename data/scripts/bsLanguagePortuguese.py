...
values = {
    ...
    'achievements':{
        ...
        'Dual Wielding':{
            'descriptionFull':'Conecte 2 controles (hardware ou aplicativo)',
    ...
    'debugWindow':{
        ...
        'runCPUBenchmarkText':'Testar desempenho da CPU',
        'runGPUBenchmarkText':'Testar desempenho da GPU',
    ...
    'editProfileWindow':{
        ...
        'iconText':'ícone',
        'localProfileInfoText':('Os perfis locais não possuem ícones e não se garante que seus\n'
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('Editar\n'
                    'Trilha sonora'),
        'fetchingITunesText':'buscando playlists do iTunes...',
    ...
    'gatherWindow':{
        ...
        'aboutDescriptionText':('Use estas guias para montar uma sala.\n'
                                '\n'
        ...
        'bluetoothDescriptionText':'Criar/entrar em uma sala pelo Bluetooth:',
        'bluetoothHostText':'Criar pelo Bluetooth',
        ...
        'hostPublicPartyDescriptionText':'Criar uma sala pública:',
        ...
        'partyInviteText':('${NAME} chamou você para\n'
                           'entrar na sala dele(a)!'),
    ...
    'store':{
        ...
        'bombSquadProNewDescriptionText':('• Remove anúncios no jogo e nas telas\n'
        ...
        'purchaseAlreadyInProgressText':'Uma compra deste item já está em progresso.',
    ...
    'wiimoteListenWindow':{
        ...
        'pressText':'Aperte os botões 1 e 2 no Wiimote simultaneamente.',
        'pressText2':'Em Wiimotes mais recentes com Motion Plus embutido, aperte o botão vermelho \'sync\' na parte de trás em seu lugar.',
    ...
    'wiimoteSetupWindow':{
        ...
        'listenText':'Procurar',
        'macInstructionsText':('Certifique-se de que o seu Wii está desligado e o Bluetooth\n'
        ...
        'thanksTextScale':0.8,
        'titleText':'Configuração do Wiimote'
    },
    ...
    'xbox360ControllersWindow':{
        ...
        'macInstructions2Text':('Para usar os controles sem fio, você também precisará de um receptor\n'
        ...
        'macInstructionsText':('Para usar os controles do Xbox 360, você precisará instalar\n'
                               'o driver Mac disponível no link abaixo.\n'
                               'Isso funciona com ambos os controles com e sem fios.'),
        'macInstructionsTextScale':0.8,
        'ouyaInstructionsText':('Para usar os controles com fio do Xbox 360 com BombSquad, basta\n'
