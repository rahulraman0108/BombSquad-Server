...
values = {
    ...
    'configGamepadWindow':{
        ...
        'uiOnlyText':'Limiter cette manette à l’utilisation du menu seulement',
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('Modifier la\n'
                    'Bande Sonore'),
        'fetchingITunesText':'chercher des playlists iTunes...',
        ...
        'useITunesPlaylistText':'Playlist d\'iTunes',
    ...
    'gatherWindow':{
        ...
        'joinPublicPartyDescriptionText':'Rejoindre un Partie Publique:',
        'localNetworkDescriptionText':'Joindre une partie sur votre réseau:',
    ...
    'internal':{
        ...
        'buttonText':'bouton',
        'cantKickHostError':'Impossible d’éjecter l\'hôte.',
        'chatBlockedText':'Tchat bloqué pour ${NAME} pendant ${TIME} secondes.',
        'connectedToGameText':'\'${NAME}\' A rejoint',
        'connectedToPartyText':'Vous avez joint la partie de ${NAME}!',
        'connectingToPartyText':'Connexion...',
        'connectionFailedHostAlreadyInPartyText':'La connexion a échouée; l\'hôte est dans une autre partie.',
        ...
        'leftGameText':'\'${NAME}\'. a quitté la partie',
        ...
        'serverRestartingText':'REDÉMARRAGE. Rejoignez dans un moment...',
    ...
    'kickVoteFailedText':'Le vote de renvoie est annulée',
    ...
    'settingsWindowAdvanced':{
        ...
        'translationFetchingStatusText':'vérificarion du statut de la traduction...',
    ...
    'translations':{
        ...
        'gameDescriptions':{
            ...
            'Defeat all enemies.':'Tuer tous les ennemis.',
        ...
        'serverResponses':{
            ...
            'Account linking successful!':'Liason des Comptes réussi!',
    ...
    'usingItunesText':'Utilise iTunes pour la bande-sonore...',
    ...
    'worldsBestScoresText':'Meilleurs scores mondial',
    'worldsBestTimesText':'Meilleurs temps mondial',
