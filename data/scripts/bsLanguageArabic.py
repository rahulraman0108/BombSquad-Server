...
values = {
    ...
    'achievements':{
        ...
        'Onslaught Master':{
            'description':'سجل 500 نقطة',
            'descriptionComplete':'سجل 500 نقطة',
            'descriptionFull':'${LEVEL} سجل 500 نقطة في',
            'descriptionFullComplete':'${LEVEL} سجل 500 نقطة في',
            'name':'${LEVEL} معلم'
        },
        'Onslaught Training Victory':{
            'description':'اهزم كل الجوالات',
            'descriptionComplete':'هزم كل الجوالات',
            'descriptionFull':'اهزم كل الجوالات في ${LEVEL}',
            'descriptionFullComplete':'${LEVEL} اهزم كل الجوالات في',
            'name':'${LEVEL} نصر'
        },
        'Onslaught Wizard':{
            'description':'سجل 1000 نقطة',
            'descriptionComplete':'سجل 1000 نقطة',
            'descriptionFull':'سجل 1000 نقطة في ${LEVEL}',
            'descriptionFullComplete':'سجل 1000 نقطة  في ${LEVEL}',
            'name':'${LEVEL} ساحر'
        },
        'Precision Bombing':{
            'description':'powerups فز بدون اي',
            'descriptionComplete':'powerups فاز بدون اي',
            'descriptionFull':'power-ups بدون اي ${LEVEL} فز',
            'descriptionFullComplete':'power-ups بدون اي ${LEVEL} فاز',
            'name':'دقة القصف'
        },
        'Pro Boxer':{
            'description':'فز دون استخدام أي قنابل',
            'descriptionComplete':'فاز بدون استخدام اي قنابل',
            'descriptionFull':'بدون استخدام اي قنابل ${LEVEL} اكمل',
            'descriptionFullComplete':'بدون استخدام اي قنابل ${LEVEL} اكمل',
            'name':'الملاكم البارع'
        },
        'Pro Football Shutout':{
            'description':'فز بدون ان تسمح للاشرار بالتسجيل',
            'descriptionComplete':'فاز بدون السماح للاشرار بالتسجيل',
            'descriptionFull':'بدون ان تسمح للاشرار بالتسجيل ${LEVEL} فز',
            'descriptionFullComplete':'بدون السماح للاشرار بالتسجيل ${LEVEL} فاز',
            'name':'${LEVEL} انتصار ساحق'
        },
        'Pro Football Victory':{
            'description':'فز في اللعبة',
            'descriptionComplete':'فاز باللعبة',
            'descriptionFull':'${LEVEL} فز في اللعبة في',
            'descriptionFullComplete':'${LEVEL} فاز في اللعبة في',
            'name':'${LEVEL} النصر'
        },
        'Pro Onslaught Victory':{
            'description':'اهزم كل الجولات',
        ...
        'Pro Runaround Victory':{
            'description':'اكمل كل الجولات',
            'descriptionComplete':'اكمل كل الجولات',
            'descriptionFull':'${LEVEL} اكمل كل الجولات في',
            'descriptionFullComplete':'${LEVEL} اكمل كل الجولات في',
            'name':'${LEVEL} النصر'
        },
    ...
    'configTouchscreenWindow':{
        ...
        'swipeControlsHiddenText':'إخفاء الرموز انتقاد',
    ...
    'connectMobileDevicesWindow':{
        ...
        'forIOSText':'لنظام التشغيل يوس:',
        'getItForText':('احصل على ${REMOTE_APP_NAME} لنظام التشغيل يوس في أبل أب ستور\n'
                        'أو لالروبوت في متجر غوغل بلاي أو الأمازون أبستور'),
    ...
    'coopSelectWindow':{
        ...
        'tournamentInfoText':('تنافس على درجات عالية مع\n'
                              ...
                              '\n'
                              'يتم منح الجوائز إلى أعلى التهديف\n'
    ...
    'copyOfText':'${NAME} نسخ',
    'createEditPlayerText':'<اصنع/عدل اللاعب>',
    'createText':'اصنع',
    'creditsWindow':{
        ...
        'legalText':'القانونية:',
        'publicDomainMusicViaText':'موسيقى النطاق العام عبر ${NAME}',
        ...
        'titleText':'${APP_NAME} من الأرصدة',
        'whoeverInventedCoffeeText':'من اخترع القهوة'
    },
    ...
    'debugWindow':{
        ...
        'runGPUBenchmarkText':'تشغيل غبو المعيار',
    ...
    'difficultyHardUnlockOnlyText':('هذا المستوى لا يمكن إلا أن تكون مقفلة في الوضع الصعب.\n'
    ...
    'disableXInputText':'تعطيل إكسينبوت',
    'doneText':'تم',
    'drawText':'تعادل',
    'duplicateText':'مكرر',
    'editGameListWindow':{
    ...
    'editProfileWindow':{
        'accountProfileInfoText':('يحتوي هذا الملف الشخصي الخاص على اسم\n'
                                  'والرمز استنادا إلى حسابك.\n'
                                  '\n'
                                  '${ICONS}\n'
                                  '\n'
                                  'إنشاء ملفات شخصية مخصصة لاستخدامها\n'
                                  'أسماء مختلفة أو الرموز المخصصة.'),
        'accountProfileText':'(تعريف حساب)',
        ...
        'globalProfileText':'(بروفايل عالمي)',
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('تصحيح\n'
                    'تسجيل صوتي'),
        'fetchingITunesText':'جار جلب قوائم تشغيل إيتونس ...',
        ...
        'useITunesPlaylistText':'اي تيونز التشغيل',
    ...
    'finishingInstallText':'التشطيب تثبيت؛ لحظة واحدة ...',
    ...
    'fourKillText':'القاتل قتل !!!',
    'friendScoresUnavailableText':'عشرات الأصدقاء غير متوفرة.',
    'gameCenterText':'مركز الالعاب',
    ...
    'gameListWindow':{
        ...
        'shuffleGameOrderText':'ترتيب المراوغة لعبة',
    ...
    'gatherWindow':{
        'aboutDescriptionLocalMultiplayerExtraText':('تذكر: أي جهاز في حفلة يمكن أن يكون أكثر من ذلك\n'
                                                     'من لاعب واحد إذا كان لديك ما يكفي من وحدات التحكم.'),
        ...
        'aboutText':'حول',
        'addressFetchErrorText':'<خطا فيتشينغ أدرسس>',
        ...
        'earnTicketsForRecommendingAmountText':('سيتلقى الأصدقاء تذاكر بقيمة ${COUNT} إذا حاولوا اللعبة\n'
        ...
        'joinPublicPartyDescriptionText':'الانضمام إلى حزب عام:',
        'localNetworkDescriptionText':'الانضمام إلى حفلة على شبكتك:',
        'localNetworkText':'شبكة مباشرة',
        'makePartyPrivateText':'جعل حفلة خاصة',
        'makePartyPublicText':'جعل حزب بلدي العامة',
        ...
        'partyInviteDeclineText':'فصل الخط',
        ...
        'partyStatusJoinableText':'حزبك الآن الانضمام من الإنترنت',
        ...
        'partyStatusNotPublicText':'حزبكم ليست عامة',
        'pingText':'التأخير',
        'portText':'ميناء',
        ...
        'titleText':'مع بعض سويا',
        'wifiDirectDescriptionBottomText':('إذا كانت جميع الأجهزة تحتوي على لوحة "واي-في ديريكت"، فيجب أن تكون قادرة على استخدامها للعثور عليها\n'
        ...
        'worksWithGooglePlayDevicesText':'(يعمل مع الأجهزة التي تعمل على جوجل بلاي (الروبوت) نسخة من اللعبة)',
    ...
    'getTicketsWindow':{
        ...
        'ticketPack6Text':'في نهاية المطاف تذكرة حزمة',
    ...
    'graphicsSettingsWindow':{
        'alwaysText':'دائما',
        'fullScreenCmdText':'ملء الشاشة (سمد-F)',
    ...
    'helpWindow':{
        'bombInfoText':('- قنبلة -\n'
                        ...
                        'للحصول على أفضل النتائج، رمي نحو\n'
                        'العدو قبل فتيل نفدت.'),
        ...
        'powerupHealthDescriptionText':('يعيد لك إلى الصحة الكاملة.\n'
                                        'كنت أبدا تخمين.'),
        'powerupHealthNameText':'ميد حزمة',
        'powerupIceBombsDescriptionText':('أضعف من القنابل العادية\n'
                                          'ولكن ترك أعدائك المجمدة\n'
                                          'ولا سيما هشاشة.'),
        'powerupIceBombsNameText':'الآيس القنابل',
        'powerupImpactBombsDescriptionText':('أضعف قليلا من العادية\n'
                                             'القنابل، لكنها تنفجر على الأثر.'),
        'powerupImpactBombsNameText':'الزناد القنابل',
        'powerupLandMinesDescriptionText':('هذه تأتي في حزم من 3؛\n'
                                           'مفيدة للدفاع قاعدة أو\n'
                                           'وقف أعداء سريع.'),
        'powerupLandMinesNameText':'الأراضي المناجم',
        'powerupPunchDescriptionText':('يجعل لكم اللكمات أصعب،\n'
                                       'أسرع، أفضل، أقوى.'),
        'powerupPunchNameText':'قفازات الملاكمة',
        'powerupShieldDescriptionText':('يمتص قليلا من الضرر\n'
                                        'لذلك لم يكن لديك ل.'),
        'powerupShieldNameText':'درع الطاقة',
        'powerupStickyBombsDescriptionText':('التمسك بأي شيء أصابته.\n'
                                             'فرحان يستتبع.'),
        'powerupStickyBombsNameText':'قنابل لاصقة',
        'powerupsSubtitleText':'وبطبيعة الحال، لا لعبة كاملة دون بووروبس:',
        'powerupsText':'زادت الطاقة',
        'punchInfoText':('-اللكمة-\n'
                         'اللكمات تعطي ضرراً أكبر\n'
                         ' حسب سرعة حركة يدك،\n'
                         ' لذا  إركض و إستدر مثل رجل مجنون.'),
        'runInfoText':('- يركض -\n'
                       'عقد أي زر لتشغيل. أزرار الزناد أو الكتف تعمل بشكل جيد إذا كان لديك.\n'
                       'تشغيل يحصل لك الأماكن بشكل أسرع ولكن يجعل من الصعب أن تتحول، لذلك احترس من المنحدرات.'),
    ...
    'hostIsNavigatingMenusText':'- ${HOST} هو التنقل القوائم مثل مدرب -',
    'importPlaylistCodeInstructionsText':'استخدم الشفرة التالية لاستيراد قائمة التشغيل هذه في مكان آخر:',
    ...
    'internal':{
        ...
        'connectionFailedHostAlreadyInPartyText':'فشل الاتصال؛ المضيف في طرف آخر.',
        'connectionFailedPartyFullText':'فشل الاتصال؛ الحزب الكامل.',
        'connectionFailedText':'فشل الاتصال.',
        'connectionFailedVersionMismatchText':('فشل الاتصال؛ المضيف هو تشغيل نسخة مختلفة من اللعبة.\n'
                                               'تأكد من أنك على حد سواء ما يصل إلى تاريخ وحاول مرة أخرى.'),
        ...
        'controllerDisconnectedTryAgainText':'تم إلغاء قطع ${CONTROLLER}. الرجاء محاولة الاتصال مرة أخرى.',
        ...
        'incompatibleVersionHostText':('المضيف هو تشغيل نسخة مختلفة من اللعبة.\n'
                                       'تأكد من أنك على حد سواء ما يصل إلى تاريخ وحاول مرة أخرى.'),
        ...
        'invitationSentText':'دعوة التي وجهت.',
        'invitationsSentText':'تم إرسال دعوات ${COUNT}.',
        'joinedPartyInstructionsText':('انضم شخص ما إلى حزبكم.\n'
        ...
        'leftPartyText':'غادر ${NAME} من الحفلات.',
        'noMusicFilesInFolderText':'المجلد لا يحتوي على ملفات الموسيقى.',
        'playerJoinedPartyText':'انضم ${NAME} إلى الحزب!',
        'playerLeftPartyText':'غادر ${NAME} الحزب.',
        'rejectingInviteAlreadyInPartyText':'رفض الدعوة (موجود بالفعل في أحد الحفلات).',
        'serverRestartingText':'إعادة تشغيل. الرجاء إعادة الانضمام في لحظة ...',
    ...
    'league':{
        ...
        'trophyCountsResetText':'سيتم إعادة تعيين التهم الكأس الموسم المقبل.'
    },
    'levelBestScoresText':'أفضل الدرجات على ${LEVEL}',
    ...
    'macControllerSubsystemMFiText':'المصممة خصيصا للدائرة الرقابة الداخلية / ماك',
    'macControllerSubsystemTitleText':'دعم المراقب المالي',
    'mainMenu':{
        'creditsText':'قروض',
        ...
        'leavePartyConfirmText':'ترك حقا الحزب؟',
        'leavePartyText':'ترك الحزب',
        'quitText':'اخرج',
        'resumeText':'استئنف',
    ...
    'noScoresYetText':'لا درجات حتى الآن.',
    ...
    'notNowText':'ليس الآن',
    'notSignedInErrorText':'يجل ان تسجل الدخول لتفعل هذا',
    ...
    'pleaseRateText':('اذا كنت تستمتع بلعبة${APP_NAME}, يرجى اتخاذ لحظة وتقييمه\n'
    ...
    'scoreChallengesText':'درجات التحديات',
    ...
    'settingsWindowAdvanced':{
        ...
        'enablePackageModsDescriptionText':'(تمكن قدرات مودينغ إضافية ولكن تعطيل صافي اللعب)',
        'enablePackageModsText':'تمكين مودلز باكيج المحلي',
        ...
        'translationNoUpdateNeededText':'اللغة الحالية هي حتى الآن. فوردعالم!',
    ...
    'soundtrackTypeNames':{
        ...
        'Chosen One':'المختار',
        'Epic':'ملحمة وضع الألعاب',
        'Epic Race':'ملحمة سباق',
    ...
    'storeDescriptionText':('8 لاعب حزب لعبة الجنون!\n'
                            '\n'
    ...
    'translations':{
        ...
        'coopLevelNames':{
            ...
            'Infinite Onslaught':'لانهائية هجمة',
        ...
        'gameDescriptions':{
            ...
            'Carry the flag for a set length of time.':'حمل العلم لمدة محددة من الزمن',
            ...
            'How fast can you defeat the ninjas?':'كيف سريع يمكنك هزيمة النينجا؟',
            'Kill a set number of enemies to win.':'قتل عدد معين من الأعداء للفوز.',
            'Last one standing wins.':'آخر واحد يقف يفوز.',
            'Last remaining alive wins.':'آخر ما تبقى من انتصارات حية.',
            'Last team standing wins.':'آخر فريق يقف يفوز.',
            'Prevent enemies from reaching the exit.':'منع الأعداء من الوصول إلى الخروج.',
            'Reach the enemy flag to score.':'الوصول إلى العلم العدو ليسجل.',
            ...
            'Score ${ARG1} goals.':'درجات ${ARG1} اهداف.',
            'Score ${ARG1} touchdowns.':'درجات ${ARG1} الهبوط',
            ...
            'carry the flag for ${ARG1} seconds':'تحمل العلم مقابل ${ARG1} ثانية',
            'kill ${ARG1} enemies':'قتل ${ARG1} الأعداء',
            'last one standing wins':'آخر واحد يقف يفوز',
            'last team standing wins':'آخر فريق يقف انتصارات',
    ...
    'usingItunesText':'...استخدام اي تيونز للموسيقى التصويرية',
    ...
    'wiimoteLicenseWindow':{
        'titleText':'داروين ريموت حقوق التأليف والنشر'
    },
    'wiimoteListenWindow':{
    ...
    'winsTeamText':'${NAME} !يفوز',
    'winsText':'${NAME} فاز',
    'worldScoresUnavailableText':'نتيجة العالم غير متوفرة',
    ...
    'xbox360ControllersWindow':{
        ...
        'macInstructions2Text':('لاستخدام وحدات تحكم لاسلكيا، سوف تحتاج أيضا المتلقي ذلك\n'
                                'يأتي مع "تحكم زبوكس 360 اللاسلكية ويندوز".\n'
