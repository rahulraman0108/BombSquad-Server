...
values = {
    'accountSettingsWindow':{
        'accountNameRules':'Имена налога не могу садржати смајлије или специјалне симболе',
        ...
        'changeOncePerSeason':'Можеш ово променити само једном током сезоне.',
        'changeOncePerSeasonError':'Мораш чекати завршетак сезоне да би ово променио опет (${NUM} дана)',
        'customName':'Сопствено име',
        'linkAccountsEnterCodeText':'Унеси код',
        'linkAccountsGenerateCodeText':'Генерирај код',
        'linkAccountsInfoText':'(подели напредак на више резличитих уређаја)',
        'linkAccountsInstructionsNewText':('Да би спојио два налога, генерирај код на првом\n'
                                           'и унеси тај код на други. Подаци са другог ће се\n'
                                           'пребацити на оба налога. (Подаци са првог налога\n'
                                           'ће бити изгубљени)\n'
                                           '\n'
        ...
        'nameChangeConfirm':'Промени име налога на ${NAME}?',
        'resetProgressConfirmNoAchievementsText':('Ово ће твој кооперативни напредак и локалне највеће \n'
                                                  'рекорде започети испочетка (али не и тикете).\n'
                                                  'Ово се не може вратити. Да ли си сигуран?'),
        'resetProgressConfirmText':('Ово ће твој кооперативни напредак,\n'
                                    'достигнућа и локалне највеће рекорде\n'
                                    '(али не и тикете) започети испочетка.\n'
                                    'Ово се не може вратити. Да ли си сигуран?'),
        'resetProgressText':'Започни испочетка напредак',
        'setAccountName':'Промени име налога',
        'setAccountNameDesc':('Изабери има које ће се приказивати на твом налогу.\n'
                              'Можеш користити име са једног од твоји повезаних\n'
                              'налога или да направиш сопствено име.'),
        'signInInfoText':('Улогуј се да зарађујеш тикете, такмичиш на мрежи\n'
                          'и делиш напредак на више различитих уређаја.'),
        'signInText':'Пријави се',
        'signInWithDeviceInfoText':'(профил достпупан једино са овог уређаја)',
        'signInWithDeviceText':'Пријави се са налогом са уређаја.',
        'signInWithGameCircleText':'Пријави се са Game Circle.',
        'signInWithGooglePlayText':'Пријави се са Google Play профилом',
        'signInWithTestAccountInfoText':'(налог за тестирање нових ствари која ће ускоро изаћи)',
        'signInWithTestAccountText':'Пријави се са тест-профилом',
        'signOutText':'Одјави се',
        'signingInText':'Пријављује се...',
        'signingOutText':'Одјављује се...',
    ...
    'achievements':{
        ...
        'Boxer':{
            ...
            'descriptionFull':'Заврши мапу ${LEVEL} без коришћења бомби',
            'descriptionFullComplete':'Завршио си мапу ${LEVEL} без коришћења бомби',
            'name':'Боксер'
        },
        'Dual Wielding':{
            'descriptionFull':'Повежи два контролера (уређај или апликацију)',
            'descriptionFullComplete':'Повезао си 2 контролера (уређај или апликација)',
            'name':'Заједничко махање'
        },
        'Flawless Victory':{
        ...
        'Free Loader':{
            'descriptionFull':'Започни "Свако за себе" игру са 2 или више играча',
            'descriptionFullComplete':'Започео си "Свако за себе" игру са 2 или више играча',
            'name':'Мини администратор'
        },
        'Gold Miner':{
            'description':'Убиј 6 непријатеља са минама',
            'descriptionComplete':'Убио си 6 непријатеља са минама',
            'descriptionFull':'Убиј 6 непријатеља са минама на мапи ${LEVEL}',
            'descriptionFullComplete':'Убио си 6 непријатеља са минама на мапи ${LEVEL}',
            'name':'Мина је згажена'
        },
        'Got the Moves':{
        ...
        'Last Stand God':{
            'description':'Постигни 1000 поена',
            'descriptionComplete':'Постигао си 1000 поена',
            'descriptionFull':'Постигни 1000 поена на мапи ${LEVEL}',
            'descriptionFullComplete':'Постигао си 1000 поена на мапи ${LEVEL}',
            'name':'${LEVEL} Бог'
        },
        'Last Stand Master':{
            'description':'Постигни 250 поена',
            'descriptionComplete':'Постигао си 250 поена',
            'descriptionFull':'Постигни 250 поена на мапи ${LEVEL}',
            'descriptionFullComplete':'Постигао си 250 поена на мапи ${LEVEL}',
            'name':'${LEVEL} мајстор'
        },
        'Last Stand Wizard':{
            'description':'Постигни 500 поена',
            'descriptionComplete':'Постигао си 500 поена',
            'descriptionFull':'Постигни 500 поена на мапи ${LEVEL}',
            'descriptionFullComplete':'Постигао си 500 поена на мапи ${LEVEL}',
            'name':'${LEVEL} чаробњак'
        },
        'Mine Games':{
            'description':'Убиј 3 непријатеља са минама',
            'descriptionComplete':'Убио си 3 непријатеља са минама',
            'descriptionFull':'Убиј 3 непријатеља са минама на мапи ${LEVEL}',
            'descriptionFullComplete':'Убио си 3 непријатеља са минама на мапи ${LEVEL}',
            'name':'Игра мина'
        },
        'Off You Go Then':{
        ...
        'Onslaught God':{
            'description':'Постигни 5000 поена',
            'descriptionComplete':'Постигао си 5000 поена',
            'descriptionFull':'Постигни 5000 поена на мапи ${LEVEL}',
            'descriptionFullComplete':'Постигао си 5000 поена на мапи ${LEVEL}',
            'name':'${LEVEL} Бог'
        },
        'Onslaught Master':{
            'description':'Постигни 500 поена',
        ...
        'Pro Football Shutout':{
            'description':'Победи без примљених поена од стране непријатеља',
            'descriptionComplete':'Победио си без примљених поена од стране непријатеља',
            'descriptionFull':'Победи на мапи ${LEVEL} без примљених поена од стране непријатеља',
            'descriptionFullComplete':'Победио си на мапи ${LEVEL} без примљених поена од стране непријатеља',
            'name':'${LEVEL} мајстор'
        },
        ...
        'Rookie Football Shutout':{
            'description':'Победи без примљеих поена од стране непријатеља',
            'descriptionComplete':'Победио си без примљених поена од стране непријатеља',
            'descriptionFull':'Победи на мапи ${LEVEL} без примљених поена од стране непријатеља',
            'descriptionFullComplete':'Победио си на мапи ${LEVEL} без примљених поена од стране непријатеља',
            'name':'${LEVEL} мајстор'
        ...
        'Rookie Football Victory':{
            ...
            'descriptionComplete':'Победио си утакмицу',
            'descriptionFull':'Победи утакмицу на мапи ${LEVEL}',
            'descriptionFullComplete':'Победио си утакмицу на мапу ${LEVEL}',
            'name':'${LEVEL} победник'
        },
        ...
        'Runaround God':{
            'description':'Постигни 2000 поена',
            'descriptionComplete':'Постигао си 2000 поена',
            'descriptionFull':'Постигни 2000 поена на мапи ${LEVEL}',
            'descriptionFullComplete':'Постигао си 2000 поена на мапи ${LEVEL}',
            'name':'${LEVEL} Бог'
        },
        'Runaround Master':{
            'description':'Постигни 500 поена',
        ...
        'Sharing is Caring':{
            ...
            'descriptionFullComplete':'Успешно позови пријатеља да игра игру',
        ...
        'The Great Wall':{
            'description':'Заустави сваког непријатеља посебно',
            'descriptionComplete':'Зауставио си сваког непријатеља посебно',
            'descriptionFull':'Заустави сваког непријатеља посебно на мапи ${LEVEL}',
            'descriptionFullComplete':'Зауставио си сваког непријатеља посебно на мапи ${LEVEL}',
            'name':'Велики зид'
        },
        'The Wall':{
            'description':'Заустави сваког непријатеља посебно',
        ...
        'Uber Football Shutout':{
            'description':'Победи без примљених поена од стране непријатеља',
            'descriptionComplete':'Победипо си без примљених поена од стране непријатеља',
            'descriptionFull':'Победи на мапи ${LEVEL} без примљених поена од стране непријатеља',
            'descriptionFullComplete':'Победио си на мапи ${LEVEL} без примљених поена од стране непријатеља',
            'name':'${LEVEL} мајстор'
        },
    ...
    'achievementsRemainingText':'Незавршена достигнућа:',
    'achievementsText':'Достигнућа',
    'achievementsUnavailableForOldSeasonsText':'Извињавамо се, информације за стару сезону нису доступне.',
    'addGameWindow':{
        'getMoreGamesText':'Набави више игри...',
        'titleText':'Додај игру'
    },
    'allowText':'Дозволи',
    'alreadySignedInText':('Овај профил је тренутно пријављен на другом уређају;\n'
                           'молимо вас да замените профил или искључите игру на\n'
                           'другом уређају и покушате поново.'),
    'apiVersionErrorText':'Не можемо учитати тај мод ${NAME}; он тражи верзију ${VERSION_USED}; ми користимо ${VERSION_REQUIRED}.',
    'audioSettingsWindow':{
        'headRelativeVRAudioInfoText':'(Активира га само када су слушалице прикључене)',
        'headRelativeVRAudioText':'Head-Relative VR Audio',
        'musicVolumeText':'Гласноћа музике',
        'soundVolumeText':'Гласноћа звука',
        'soundtrackButtonText':'Музичка трака',
        'soundtrackDescriptionText':'(дозвољава да пусташ своју сопствену музику током игре)',
        'titleText':'Аудио'
    },
    'autoText':'Аутоматски',
    'backText':'Назад',
    'banThisPlayerText':'Избаци играча',
    'bestOfFinalText':'Први до ${COUNT} - Победник',
    'bestOfSeriesText':'Први до ${COUNT} победа:',
    ...
    'bombText':'Бомба',
    'boostText':'Појачај',
    'bsRemoteConfigureInAppText':'${REMOTE_APP_NAME} је подешен на свој начин.',
    'buttonText':'дугме',
    'canWeDebugText':('Да ли желиш да BombSquad аутоматски шање извештај о кваровима,\n'
                      'падовима и основним информацијама о коришћењу девелоперу?\n'
                      '\n'
    ...
    'completionBonusText':'Завршетак бонуса',
    'configControllersWindow':{
        'configureControllersText':'Намести контроле',
        'configureKeyboard2Text':'Намести тастатуру П2',
        'configureKeyboardText':'Намести тастатуру',
        'configureMobileText':'Мобилни уређаји као контролори',
        'configureTouchText':'Намести екран',
        'ps3Text':'PS3 контролори',
        'titleText':'Контролори',
        'wiimotesText':'Wiimotes',
        'xbox360Text':'Xbox 360 контролори'
    },
    'configGamepadSelectWindow':{
        'androidNoteText':'Обавштење: помоћни контролори варирају у зависности од уређаја и Андроид верзије.',
        'pressAnyButtonText':('Притисни било које дугме на контролеру\n'
                              'које желиш да прилагодиш...'),
        'titleText':'Прилагоди контролере'
    },
    'configGamepadWindow':{
        'advancedText':'Напредна подешавања',
        'advancedTitleText':'Напредно подешавање контролера',
        'analogStickDeadZoneDescriptionText':'(упали ово уколико твој лик клиза и након пуштања дугмета за кретање)',
        'analogStickDeadZoneText':'Мртва зона аналогног дугмета',
        'appliesToAllText':'(важи за све контролере ове врсте)',
        'autoRecalibrateDescriptionText':'(укључи ово ако се твој лик не креће пуном брзином)',
        'autoRecalibrateText':'Аутоматски калибрирај аналогно дугме',
        'axisText':'оса',
        'clearText':'очисти',
        'dpadText':'окидач',
        'extraStartButtonText':'Екстра стартно дугме',
        'ifNothingHappensTryAnalogText':'Ако се ништа не дешава, пробај пренети на анлогно дугме уместо тога.',
        'ifNothingHappensTryDpadText':'Ако се ништа не дешава, пробај да упослиш окидач уместо тога.',
        'ignoreCompletelyDescriptionText':'(спречи ово контролер да утиче на игру или мени)',
        'ignoreCompletelyText':'Игнориши комплентно',
        ...
        'ignoredButtonDescriptionText':'(користи ово да спречиш "кућа" и "синхронизација" дугмад да утичу на UI)',
        'pressAnyAnalogTriggerText':'Притисни неки аналогни окидач...',
        'pressAnyButtonOrDpadText':'Притисни неко дугме или окидач...',
        'pressAnyButtonText':'Притисни било које дугме...',
        'pressLeftRightText':'Притисни лево или десно...',
        'pressUpDownText':'Притисни горе или доле...',
        'runButton1Text':'Покрени дугме 1',
        'runButton2Text':'Покрени дугме 2',
        'runTrigger1Text':'Покрени окидач 1',
        'runTrigger2Text':'Покрени окидач 2',
        'runTriggerDescriptionText':'(аналогни окидачи дозвољавају ти да трчиш у променљивим брзинама)',
        'secondHalfText':('Користи ово да наместиш другу половину\n'
                          '"2 у 1" контролера уређају који\n'
        ...
        'startButtonActivatesDefaultText':'Стартно дугме активира подразумеване пречице',
        'titleText':'Подешавање контролера',
        'twoInOneSetupText':'2 у 1 подешавање контролера',
        'uiOnlyDescriptionText':'(спречи да уз помоћ овог контролера улазиш у игру)',
        'uiOnlyText':'Ограничи коришћење менија',
        'unassignedButtonsRunText':'Покрени сва дугмад са недодељеном командом',
        'unsetText':'<неподешено>',
        'vrReorientButtonText':'VR преусмерено дугме'
    },
    'configKeyboardWindow':{
        'configuringText':'Конфигурисање ${DEVICE}',
        'keyboard2NoteText':('Обавештење: Већiна тастатура може да региструје само неколико притиска\n'
                             'одједном, зато ако имаш другу тастатуру играч би можда боље радио \n'
                             'ако би посебна тастатура била укључена да би је он користио.\n'
                             'Обавештење које ти такође треба јесте да у том случају упослиш\n'
                             'различитe тастере за два играча.')
    },
    'configTouchscreenWindow':{
        'actionControlScaleText':'Величина контролера акције',
        'actionsText':'Акција',
        'buttonsText':'дугмад',
        'dragControlsText':'< вуци контролере да их помериш >',
        'joystickText':'џојстик',
        'movementControlScaleText':'Величина контролера кретања',
        'movementText':'Кретање',
        'resetText':'Ресетуј',
        'swipeControlsHiddenText':'Сакриј иконице на повлачење',
        'swipeInfoText':('"Повлаченје" стил контрола је мање коришћен али \n'
                         'је лекше играти без гледања у контроле.'),
        'swipeText':'превуци',
    ...
    'connectMobileDevicesWindow':{
        ...
        'bestResultsText':('За најбоље резултате треба ти интернет без кашњења. Можеш\n'
                           'смањити кашњења тако што ћеш искључити остале бежичне уређаје,\n'
                           'играти близу твог Wi-Fi рутера или конектовати се на игру\n'
                           'која је направљена директно са интернета који ти користиш.'),
        'explanationText':('Дда би користио памтни телефон или таблет као бежични контролер,\n'
                           'инталирај "${REMOTE_APP_NAME}" апликацију на њега. било који број уређаја\n'
                           'можеш повезати на ${APP_NAME} игрицу преко Wi-Fi-а, и то скроз бесплатно!'),
        'forAndroidText':'За Android:',
        'forIOSText':'за iOS:',
        'getItForText':('Преузми ${REMOTE_APP_NAME} за iOS преко Apple App Store\n'
                        'или за Android у Google Play Store или Amazon Appstore'),
    ...
    'coopSelectWindow':{
        ...
        'activenessInfoText':('Овај множилац расте данима када ти\n'
                              'играш и опада данима када не играш.'),
        ...
        'powerRankingPointsEqualsText':'= ${NUMBER} поена',
        'powerRankingPointsMultText':'(x ${NUMBER} поена)',
        'powerRankingPointsText':'${NUMBER} поена',
        ...
        'welcome1Text':('Добродоша у ${LEAGUE}. Можеш повежати свој ранк\n'
                        'у лиги освајајући звездице, зевршавајући задатке\n'
                        'и освајајући трофеје на турнирима.'),
        'welcome2Text':('Тикете можеш освојити у много сличних активности.\n'
                        'Тикете можеш да користиш да би откључао нове ликове, \n'
                        'мапе и мини-игре, да уђеш на турнир и тако даље.'),
    ...
    'creditsWindow':{
        ...
        'codingGraphicsAudioText':'Шифре, графике и аудио су од ${NAME}',
        'languageTranslationsText':'Преводили су: (за српски - Igomen)',
        'legalText':'Легално:',
        'publicDomainMusicViaText':'Музика јавног домена од ${NAME}',
        'softwareBasedOnText':'Овај софтвер је базиран делом на рад од ${NAME}',
        'songCreditText':('${TITLE} је изведен од стране ${PERFORMER}\n'
                          'Састављено од стране ${COMPOSER}, уређено од стране ${ARRANGER}, објављено од стране ${PUBLISHER},\n'
                          'учтивост од ${SOURCE}'),
    ...
    'deathsTallyText':'${COUNT} смрти',
    'deathsText':'Смрти',
    'debugText':'отклонити багове',
    'debugWindow':{
        ...
        'runCPUBenchmarkText':'Покрени CPU Benchmark',
        'runGPUBenchmarkText':'Покрени GPU Benchmark',
        'runMediaReloadBenchmarkText':'Покрени Media-Reload Benchmark',
        'runStressTestText':'Покрени стрес тест',
        'stressTestPlayerCountText':'Број играча',
        'stressTestPlaylistDescriptionText':'Листа игара на стрес тесту',
        ...
        'stressTestTitleText':'Стрес тест',
        'titleText':'Benchmark и стрес тест',
        'totalReloadTimeText':'Укупно време поновног учитавања: ${TIME} (погледај дневник за информације)'
    },
    ...
    'difficultyHardUnlockOnlyText':('Овај ниво може да се откључа само на тешком моду.\n'
                                    'Да ли мислиш да имаш све што ти треба!?!?!'),
    'directBrowserToURLText':'Молимо вас усмерите web-претарживач на следећи URL:',
    'disableRemoteAppConnectionsText':'Онемогући повезивање Remote апликације',
    'disableXInputDescriptionText':'Дозвољава више од 4 контролера али су могући проблеми.',
    'disableXInputText':'Искључи XInput',
    'doneText':'Заврши',
    'drawText':'Нерешено',
    ...
    'editGameListWindow':{
        'addGameText':('Додај\n'
                       'игру'),
        'cantOverwriteDefaultText':'Не можеш преписати подразумевану листу игара!',
    ...
    'editProfileWindow':{
        'accountProfileInfoText':('Овај специјални профил има име и \n'
                                  ...
                                  '${ICONS}\n'
                                  '\n'
                                  'Направи сопствене профиле да их користиш\n'
                                  'за различитим именима или иконицама.'),
        'accountProfileText':'(профил налога)',
        'availableText':'Име "${NAME}" је доступно.',
        'characterText':'лик',
        'checkingAvailabilityText':'Проверавање доступности за "${NAME}"...',
        'colorText':'боја',
        ...
        'globalProfileInfoText':('Профили глобалних играча загарантовано имају јединствена \n'
                                 'имена широм света. Она такође укључуу јединствене иконице.'),
        'globalProfileText':'(глобални профил)',
        'highlightText':'врхунац',
        'iconText':'иконица',
        'localProfileInfoText':('Профили локалних играча немају иконице и није загарантовано\n'
                                'да ће њихова имена бити јединствена. Унапреди на глобални \n'
                                'профил да резервишеш јединствено име и доадаш сопствене иконице.'),
        ...
        'upgradeProfileInfoText':('Ово ће резервисати твоје име широм света и \n'
                                  'дозволиће ти да додаш сопствену иконицу на њега.'),
        'upgradeToGlobalProfileText':'Унапреди на глобални профил'
    },
    'editSoundtrackWindow':{
        'cantDeleteDefaultText':'Не можеш обрисати подразумевану звучну траку.',
        'cantEditDefaultText':'Не можеш измењивати подразумевану звучну траку. Дуплирај је или направи нову.',
        'cantOverwriteDefaultText':'Не можеш преписати подразумевану звучну траку',
        'cantSaveAlreadyExistsText':'Звучна трака са тим именом већ постоји!',
        'defaultGameMusicText':'<подразумевана музика у игри>',
        'defaultSoundtrackNameText':'Подразумевана звучна трака',
        'deleteConfirmText':('Обриши звучну траку?\n'
                             '\n'
                             '"${NAME}"?'),
        'deleteText':('Обриши\n'
                      'звучну траку'),
        'duplicateText':('Дуплирај\n'
                         'звучну траку'),
        'editSoundtrackText':'Уређивање звучних трака',
        'editText':('Измени\n'
                    'звучну траку'),
        'fetchingITunesText':'преузимање листе игара са iTunes...',
        'musicVolumeZeroWarning':'Пажња: јачина музике је подешена на 0',
        'nameText':'Име',
        'newSoundtrackNameText':'Моја звучна листа ${COUNT}',
        'newSoundtrackText':'Нова звучна листа:',
        'newText':('Нова\n'
                   'звучна листа'),
        'selectAPlaylistText':'Изабери листу игара',
        'selectASourceText':'Извор музике',
        'testText':'тест',
        'titleText':'Звучна листа',
        'useDefaultGameMusicText':'Подразумевана музика у игри',
        'useITunesPlaylistText':'iTunes листа игара',
        'useMusicFileText':'Музички фајл (mp3 и сл.)',
        'useMusicFolderText':'Фолдер са музичким фајловима'
    },
    'editText':'Измени',
    'endText':'Крај',
    'enjoyText':'Уживај!',
    'epicDescriptionFilterText':'${DESCRIPTION} у епској успореној игри.',
    ...
    'finishingInstallText':'Сачекајте моменат, завршавање инсталација...',
    ...
    'fiveKillText':'ПЕТОСТРУКО УБИСТАВO!!!',
    ...
    'gameListWindow':{
        'cantDeleteDefaultText':'Не можеш да обришеш подразумевану листу игара.',
        'cantEditDefaultText':'Не можеш да измениш подразумевану листу игара! Дуплирај је или направи нову.',
        'cantShareDefaultText':'Не можеш да делиш подразумевану листу игара.',
    ...
    'gatherWindow':{
        ...
        'aboutDescriptionText':('Користи ове уметке да организујеш заједницу.\n'
                                '\n'
        ...
        'appInviteMessageText':'${NAME} ти је послао ${COUNT} тикета у ${APP_NAME}',
        'appInviteSendACodeText':'Пошаљи им код',
        'appInviteTitleText':'${APP_NAME} позив за апликацију',
        'bluetoothAndroidSupportText':'(ради са било којим Андроид уређајом који подржава Bluetooth)',
        'bluetoothDescriptionText':'Буди домаћин/придружи се заједници преко Bluetooth-а:',
        'bluetoothHostText':'Буди домаћин преко Bluetooth-а',
        'bluetoothJoinText':'Придружи се преко Bluetooth-а',
        ...
        'disconnectClientsText':('Ово ће уклонити ${COUNT} играча са твоје\n'
        ...
        'friendHasSentPromoCodeText':'Добили сте ${COUNT} ${APP_NAME} тикета од ${NAME}',
        ...
        'friendPromoCodeInstructionsText':('Да би га искористио, отвори ${APP_NAME} и иди у "Подешавања->Напредна подешавања->\n'
                                           'Унеси код". Погледај bombsquadgame.com да преузмеш линк за све подржане платформе.'),
        'friendPromoCodeRedeemLongText':'Може се откупити за ${COUNT} бесплатних тикета од стране ${MAX_USES} људи.',
        'friendPromoCodeRedeemShortText':'Може се откупити за ${COUNT} тикета у игри.',
        'friendPromoCodeWhereToEnterText':'(у Подешавања->Напредна подешавања->Унеси код")',
        'getFriendInviteCodeText':'Узми позивни код за пријатеља',
        'googlePlayDescriptionText':'Позови Google Play играче у твоју заједницу:',
        ...
        'googlePlayReInviteText':('У твојој заједници је ${COUNT} играч/а који ће\n'
                                  ...
                                  'и њих у нови позив за игру да их вратиш.'),
        'googlePlaySeeInvitesText':'Погледај позиве',
        'googlePlayText':'Google Play',
        'googlePlayVersionOnlyText':'(Андроид / Google Play верзија)',
        'hostPublicPartyDescriptionText':'Буди домаћин у јавној заједници:',
        'inDevelopmentWarningText':('Обавештење:\n'
                                    '\n'
                                    'Мрежна игра је нова ствар и још увек се поправља.\n'
                                    'За сада је препоручљиво да сви играчи\n'
                                    'буду на истој Wi-Fi мрежи.'),
        ...
        'joinPublicPartyDescriptionText':'Придружи се јавној заједници:',
        'localNetworkDescriptionText':'Придружи се заједници на твојој мрежи:',
        ...
        'manualJoinableFromInternetText':'Да ли можеш да се прикључиш преко интернета?:',
        'manualJoinableNoWithAsteriskText':'НЕ*',
        'manualJoinableYesText':'ДА',
        'manualRouterForwardingText':'*да поправиш ово, покушај да наместиш свој рутер да проследи UDP порт ${PORT} на твоју локалну адресу',
        'manualText':'Ручни',
        ...
        'partyInviteGooglePlayExtraText':'(погледај "Google Play" уметак у "Окупљање" прозору)',
        'partyInviteIgnoreText':'Ignoriši',
        'partyInviteText':('${NAME} је позван да се\n'
                           'придружи њиховој заједници!'),
        'partyNameText':'Име заједнице',
        'partySizeText':'величина заједнице',
        'partyStatusCheckingText':'проверавање статуса...',
        'partyStatusJoinableText':'сада је могуће придружити се са интернета твојој заједници',
        'partyStatusNoConnectionText':'није могуће повезивање на сервер',
        'partyStatusNotJoinableText':'Није могуће придружити се твојој заједници са интернета',
        ...
        'showMyAddressText':'Пошаљи моју адресу',
        'titleText':'Окупљање',
        'wifiDirectDescriptionBottomText':('Ако сви уређаји имају "Wi-Fi Direct", они би то могли користити да нађу и да се\n'
                                           'повежу једни на друге. Када су сви уређаји повезани, овде можеш образовати \n'
                                           'заједнице користећи "Локална мрежа" уметак, исто као и са регуларном Wi-Fi мрежом.\n'
                                           '\n'
                                           'За најбоље резултате, Wi-Fi Direct домаћин би такође требало да буде домаћин ${APP_NAME} заједнице.'),
        'wifiDirectDescriptionTopText':('Wi-Fi Direct се може користити да се директно повежу Андроид уређаји без\n'
                                        'Wi-Fi мреже. Ово најбоље ради на Андроид 4.2 или новијим верзијама.\n'
                                        '\n'
                                        'Да би користио ово, отвори Wi-Fi подешавања и потражи "Wi-Fi Direct" у менију.'),
        'wifiDirectOpenWiFiSettingsText':'Отвори Wi-Fi подешавања',
        'wifiDirectText':'Wi-Fi Direct',
        'worksBetweenAllPlatformsText':'(ради између свих платформи)',
        'worksWithGooglePlayDevicesText':'(ради са уређајима који имају Google Play (андроид) верзију игре)',
    ...
    'getTicketsWindow':{
        ...
        'purchasesRestoredText':'Куповине одновљене.',
        'receivedTicketsText':'Добио си ${COUNT} тикета!',
        'restorePurchasesText':'Врати куповине',
        ...
        'unavailableLinkAccountText':('Извињавамо се, куповина није доступна на овој платформи.\n'
                                      ...
                                      'платформи и изведеш куповину ту.'),
    ...
    'helpWindow':{
        'bombInfoText':('- Бомба -\n'
                        'Јача од удараца, али \n'
                        'може довести до самоповређивања.\n'
                        'За најбоље резултате, баци је испред\n'
        ...
        'controllersInfoText':('Можеш да играш ${APP_NAME} са пријатељима преко мреже, или \n'
                               ...
                               '${APP_NAME} подржава доста њих; такође можете користити \n'
        ...
        'controlsSubtitleText':'Твој пријатељски ${APP_NAME} лик има неколико основних акција:',
        'controlsText':'Контроле',
        'devicesInfoText':('VR верзија ${APP_NAME}-а може да се игра преко мреже са регуларном\n'
                           'верзијом, зато извадите ваше додатне телефоне, таблете и компјутере\n'
                           'и узмите вашу игру. Такође може бити корисно да повежете регуларну\n'
                           'верзију игре на VR верзију само да дозволите људима споља да\n'
                           'гледају акцију.'),
        'devicesText':'Уређаји',
        ...
        'jumpInfoText':('- Скок -\n'
                        ...
                        'да бациш ствари више,  и да\n'
                        'изразиш осећања радости.'),
        'jumpInfoTextScale':0.6,
        'orPunchingSomethingExtraSpace':0,
        'orPunchingSomethingText':'Или ударао нешто, бацао са литице и разносио га у паду са лепљивом бомбом.',
        ...
        'powerupBombDescriptionText':('Дозвољава ти да бациш за редом\n'
                                      'три бомбе уместо само једне.'),
        ...
        'powerupHealthDescriptionText':('Враћа цело твоје здравље.\n'
                                        'Никад не би погодио.'),
        'powerupHealthNameText':'Медицински пакет',
        'powerupIceBombsDescriptionText':('Спорије неко нормалне бомбе\n'
        ...
        'runInfoText':('- Трчање -\n'
                       'Држи БИЛО КОЈЕ дугме да трчиш. Дугмад на повлачење или обична раде боље ако их имате.\n'
        ...
        'someDaysText':'Неким данима се осећаш као да би ударао нешто. Или разносио нешто у ваздух.',
    ...
    'importPlaylistCodeInstructionsText':'Користи следећи код да увезеш негде ову листу пуштања:',
    'importPlaylistSuccessText':'"${NAME}" ${TYPE} листа пуштања увезена',
    'importText':'Увези',
    ...
    'internal':{
        ...
        'connectionFailedVersionMismatchText':('Конекција неуспела; домаћин користи другу верзију игре.\n'
                                               'Буди сигуран да користиш најновију верзију.'),
        ...
        'corruptFileText':'Пронађени претећи фајлови. Покушај да поново инсталираш игру или пошаљи поруку на ${EMAIL}',
        'errorPlayingMusicText':'Грешка при пуштању музике: ${MUSIC}',
        'errorResettingAchievementsText':'Немогуће рестартовање достигнућа на мрежи; молимо вас покушајте касније.',
        ...
        'incompatibleVersionHostText':('Домаћин користи другу верзију игре. Буди сигуран\n'
                                       'да сте обојица усклађени са верзијама и покушај опет.'),
        'incompatibleVersionPlayerText':('${NAME} користи другу верзију игре. Буди сигуран\n'
                                         'да сте обојица усклађени са верзијама и покушај опет.'),
        ...
        'kickIdlePlayersKickedText':'Избацивање ${NAME} због неактивности.',
        'kickIdlePlayersWarning1Text':'${NAME} ће бити избачен за ${COUNT} секунди ако остане неактиван.',
        'kickIdlePlayersWarning2Text':'(ово можеш да искључиш у Подешавања -> Напредна подешавања)',
        'leftGameText':'${NAME} је изашао.',
        'leftPartyText':'Изађи из ${NAME} заједнице.',
        ...
        'rejectingInviteAlreadyInPartyText':'Одбијање позива (већ си у заједници).',
        'serverRestartingText':'РЕСТАРТОВАЊЕ. Молимо вас уђите опет за који моменат.',
        ...
        'timeOutText':'(време истиче за ${TIME} секунди)',
        ...
        'vrOrientationResetCardboardText':('Користи ово да рестартујеш VR оријентацију.\n'
                                           'Да би играо игру требаће ти спољни контролер.'),
        'vrOrientationResetText':'VR оријентација рестартована.',
    ...
    'kickVoteStartedText':'Гласање за избацивање за ${NAME} је стартовано.',
    'kickVoteText':'Гласај за избацивање.',
    'kickWithChatText':'Напиши ${YES} у ћаскању за избацивање и ${NO} за неизбацивање.',
    ...
    'kioskWindow':{
        ...
        'versusExamplesText':'Примери борбе против...'
    },
    ...
    'league':{
        ...
        'leagueFullText':'${NAME} лига',
        'leagueRankText':'Ранк у лиги',
        'leagueText':'Лига',
        'rankInLeagueText':'#${RANK}, ${NAME} лига${SUFFIX}',
        ...
        'tournamentLeagueText':'Мораш прећи ${NAME} лигу да уђеш у овај турнир.',
        'trophyCountsResetText':'Број трофеја ће се рестартовати следеће сезоне.'
    },
    'levelBestScoresText':'Најбољи резултати на ${LEVEL}',
    'levelBestTimesText':'Најбоља времена на ${LEVEL}',
    'levelIsLockedText':'${LEVEL} је закључан.',
    'levelMustBeCompletedFirstText':'Прво мора бити завршен ${LEVEL}.',
    ...
    'macControllerSubsystemMFiNoteText':('iOS/Mac контролери су пронађени;\n'
                                         'Можда желиш да их омогућиш у Подешавања -> Контролери'),
    'macControllerSubsystemMFiText':'iOS/Mac',
    'macControllerSubsystemTitleText':'Подршка за контролере',
    'mainMenu':{
        'creditsText':'Заслуга',
    ...
    'mapText':'Мапа',
    'maxConnectionsText':'Максималне конекције',
    ...
    'mustInviteFriendsText':('Обавештење: мораш да позовеш пријатеље\n'
                             'у "${GATHER}" табли или прикњучиш\n'
                             'контролере да играш са више играча.'),
    'nameBetrayedText':'${NAME} је издао ${VICTIM}.',
    'nameDiedText':'${NAME} је умро.',
    'nameKilledText':'${NAME} је убио ${VICTIM}.',
    ...
    'newTestBuildAvailableText':('Новијi систем за тестирање је доступан! (${VERSION} прави ${BUILD}).\n'
                                 'Набави је на ${ADDRESS}'),
    'newText':'Ново',
    ...
    'noGameCircleText':'Грешка: ниси пријавњен на GameCircle',
    ...
    'notEnoughPlayersRemainingText':'Није остало довољно играча; изађи у започни нову игру.',
    'notEnoughPlayersText':'Требаш најмање ${COUNT} играча да започнеш игру!',
    'notNowText':'Не сада',
    'notSignedInErrorText':'Мораш бити пријављен да радиш ово.',
    'notSignedInGooglePlayErrorText':'Мораш бити пријавњен на Google Play да радиш ово.',
    ...
    'packageModsEnabledErrorText':'Мрежна игра није дозвоњена док је "локални пакет модова" искључен (погледај Подешавања->Напредна подешавања)',
    'partyWindow':{
    ...
    'pickUpText':'Покупи',
    'playModes':{
        'coopText':'Кооперативни мод',
        'freeForAllText':'Свако за себе',
        'multiTeamText':'Мали тимови',
        'singlePlayerCoopText':'Соло игра / Кооперативни мод',
        'teamsText':'Тимови'
    },
    'playText':'Играј',
    'playWindow':{
    ...
    'playerLimitReachedText':'Лимит од ${COUNT} играча је достигнут; није дозвољен улазак новим играчима.',
    'playerProfilesWindow':{
        'cantDeleteAccountProfileText':'Не можеш да обришеш профил твог налога.',
        'deleteButtonText':('Обриши\n'
                            'профил'),
        'deleteConfirmText':'Обриши "${PROFILE}"?',
    ...
    'playerText':'Играч',
    'playlistNoValidGamesErrorText':'Ова листа игара садржи игре које нису откључане валидно.',
    'playlistNotFoundText':'није нађена листа игара',
    'playlistsText':'Листа игара',
    'pleaseRateText':('Ако уживате у ${APP_NAME}, молимо вас да издвојите мало\n'
                      'времена да оцените апликацију или напишете  коментар. Ово\n'
                      'нам даје корисне информације и помаже у будућем развоју.\n'
                      '\n'
                      'Хвала!\n'
                      '-Ерик'),
    'pleaseWaitText':'Молимо вас сачекајте...',
    'practiceText':'Увежбавање',
    ...
    'ps3ControllersWindow':{
        'macInstructionsText':('Искључи напајање са задње стране PS3, буди сигуран да је\n'
                               ...
                               'на Mac преко USB кабла да упариш ова два. Сада можеш да\n'
                               'искористиш контролерово стартно дугме да га повежеш на Mac\n'
                               'или преко кабла (USB) или бежично (Bluetooth).\n'
                               '\n'
                               'На неким Mac уређајима можете бити упитани за шифру током упаривања.\n'
                               'Ако се ово деси погледај следећи туториал или Гугл за помоћ.\n'
                               '\n'
                               '\n'
                               '\n'
                               '\n'
                               'PS3 контролери конектовани бежично би требали бити приказани на\n'
                               'листи урађаја у System Preferences->Bluetooth. Можда ћеш требати да\n'
                               'их уклониш са те листа ако хоћеш да их поново користиш на твом PS3.\n'
                               '\n'
                               'Такође буди сигуран да више нису повезани на Bluetooth када их не\n'
                               'користиш или ће батерија наставити да се троши.\n'
                               '\n'
                               'Bluetooth би требало да издржи 7 повезаних уређаја, мада може да\n'
                               'варира.'),
        'macInstructionsTextScale':0.74,
        'ouyaInstructionsText':('Да користиш PS3 контролер са твојим OUYA, једноставно их једном повежи са\n'
                                'USB каблом да их упариш. Радећи ово остали контролери можда више неће бити\n'
                                'конектовани, зато би требало да растартујеш OUYA и извадиш USB кабл.\n'
                                '\n'
                                'Сада би требао да можеш да искористиш контролерово HOME дугме да их \n'
                                'конектујеш бежично. Када завршиш са играњем, држи HOME дугме 10 секунди\n'
                                'да искључиш контролер; иначе ако остану укључени трошиће батерију на \n'
                                'уређају.'),
        'ouyaInstructionsTextScale':0.74,
        'pairingTutorialText':'видео-туториал за упаривање',
        'titleText':'Користи PS3 контролер са ${APP_NAME}:'
    },
    ...
    'rankText':'Ранк',
    'ratingText':'Оцена',
    'reachWave2Text':'Достигни рунду 2 да добијеш ранк.',
    'readyText':'спреман',
    'recentText':'Скоро',
    'remoteAppInfoShortText':('${APP_NAME} је најзабавнији када се игра са породицом или\n'
                              'пријатељима. Повежи један или више контролера и инсталирај\n'
    ...
    'remote_app':{
        ...
        'capturing':'Чекање...',
        'connected':'Повезано.',
        'description':('Користи свој телефон или таблет као контролер за BombSquad.\n'
        ...
        'version_mismatch':('Верзије се не подударају.\n'
                            'Буди сигуран да су BombSquad и BombSquad\n'
    ...
    'replayRenameWarningText':'Промени име "${REPLAY}" после игре ако хоћеш да га сачуваш; у другом случају ће бити избрисан.',
    ...
    'requestingText':'Захтевање...',
    'restartText':'Рестарт',
    'retryText':'Покушај опет',
    'revertText':'Врати',
    'runText':'Трчање',
    'saveText':'Сачувај',
    'scanScriptsErrorText':'Грешка(е) у скенирању скрипти; видите логове за детаље.',
    ...
    'settingsWindow':{
        'accountText':'Налог',
        'advancedText':'Напредно подешавање',
        'audioText':'Audiо',
        'controllersText':'Контролери',
        'graphicsText':'Графика',
        'playerProfilesMovedText':'Обавештење: Профили играча су померени у прозор "Профили" у главном менију.',
        'titleText':'Подешавања'
    },
    'settingsWindowAdvanced':{
        'alwaysUseInternalKeyboardDescriptionText':'(једноставна, контролна тастатура не екрану за уређивање текста)',
        'alwaysUseInternalKeyboardText':'Увек користи интерну тастатуру',
        'benchmarksText':'Benchmarks и стрес тест',
        'disableThisNotice':'(можеш да искључиш ову објаву у напредним подешавањима)',
        'enablePackageModsDescriptionText':'(омогућивањем убациња додатних модова се онемогућава игра на мрежи)',
        'enablePackageModsText':'Омогући локални пакет модова',
        'enterPromoCodeText':'Унеси код',
        'forTestingText':'Обавештење: ове вредности су само за тестирање и биће изгубљене када апликација изађе.',
        'helpTranslateText':('${APP_NAME} језички преводи су рад играча. Ако би желео да\n'
                             'измениш превод, прати линк испод или контактирај igomen15@gmail.com\n'
                             'ако желиш одговор за твоје измене. Хвала у сваком случају!'),
        ...
        'resetText':'Рестартуј',
        'showBombTrajectoriesText':'Покажи путању бомби',
        'showPlayerNamesText':'Покажи имена играча',
        'showUserModsText':'Покажи фолдер са модовима',
        'titleText':'Напредно',
        'translationEditorButtonText':'${APP_NAME} измењивање превода',
        'translationFetchErrorText':'недоступан статус превођења',
        ...
        'translationNoUpdateNeededText':'тренутни језик је спреман за нове преводе; јуупии!',
        'translationUpdateNeededText':'** тренутни језик треба додатне измене!! **',
        'vrTestingText':'Тестирање VR'
    },
    'shareText':'Подели',
    'sharingText':'Дељење...',
    ...
    'soundtrackTypeNames':{
        ...
        'Chosen One':'Изабери једног',
        'Epic':'Епски мод игара',
        'Epic Race':'Епска трка',
        'FlagCatcher':'Узми заставу',
        'Flying':'Лепе мисли',
        'Football':'Фудбал',
        'ForwardMarch':'Напад',
        'GrandRomp':'Освајање',
        'Hockey':'Хокеј',
        'Keep Away':'Држи се подаље',
        'Marching':'Јурцање',
        'Menu':'Главни мени',
        'Onslaught':'Напад',
        'Race':'Трка',
    ...
    'store':{
        ...
        'extrasText':'Додаци',
        'freeBombSquadProText':('BombSquad је сада бесплатан, али пошто си је већ платио добићеш\n'
        ...
        'iconsText':'Иконице',
        'loadErrorText':('Немогуће да се страница учита.\n'
                         'Провери своју интернет конекцију.'),
        'loadingText':'учитавање',
        'mapsText':'Мапе',
        'miniGamesText':'Мини игре',
        'oneTimeOnlyText':'(само једном)',
    ...
    'storeDescriptionText':('Лудница за заједницу од 8 играча!\n'
                            '\n'
                            'Разнеси своје пријатеље (или компјутер) у турнирима експлозивних мини игара као на пример: "Узми заставу", "Експлзивни хокеј" и "Епски успорена смртна борба"!\n'
                            '\n'
    ...
    'testBuildValidateErrorText':'Није могуће проверити систем за тестирање. (нема интернет конекције?)',
    ...
    'translations':{
        ...
        'coopLevelNames':{
            ...
            'Infinite ${GAME}':'Бесконачни "${GAME}"',
            'Infinite Onslaught':'Бесконачна инвазија',
            'Infinite Runaround':'Бесконачнo јурцање',
            'Onslaught Training':'Тренинг инвазије',
            'Pro ${GAME}':'Професионални "${GAME}"',
        ...
        'gameDescriptions':{
            ('Be the chosen one for a length of time to win.\n'
             'Kill the chosen one to become it.'):('Буди одабран на одређено време да победиш.\n'
                                                   'Убиј одабраног да постанеш он.'),
            ...
            'Score ${ARG1} touchdowns.':'Постигни ${ARG1} слетања.',
            'Score a goal.':'Постигни гол.',
            'Score a touchdown.':'Постигни слетање.',
        ...
        'gameNames':{
            ...
            'Race':'Трка',
            'Runaround':'Јурцање',
            'Target Practice':'Вежбање гађања мете',
            'The Last Stand':'Последњи преживели'
        },
        'inputDeviceNames':{
            'Keyboard':'Тастатура',
        ...
        'mapsNames':{
            ...
            'Bridgit':'Бриџит',
            'Courtyard':'Двориште',
            'Crag Castle':'Замак Крегова',
            'Doom Shroom':'Зла печурка',
            'Football Stadium':'Фудбалски стадион',
            'Happy Thoughts':'Срећне мисли',
            'Hockey Stadium':'Хокејашки стадион',
            'Lake Frigid':'Језеро Фриџид',
            'Monkey Face':'Мајмунско лице',
            'Rampage':'Јарост',
            'Roundabout':'Вртешка',
            'Step Right Up':'Закорачи',
            'The Pad':'Платформа',
            'Tip Top':'Тип топ',
            'Tower D':'Торањ Де',
            'Zigzag':'Цик-цак'
        ...
        'scoreNames':{
            ...
            'Survived':'Преживео',
            'Time':'Време',
            'Time Held':'Времена издржао'
        },
        'serverResponses':{
            'A code has already been used on this account.':'Код је већ био коришћен на овом налогу.',
            'A reward has already been given for that address.':'Награда је већ предата за ову адресу.',
            ...
            ('Received ${COUNT} tickets for signing in.\n'
             'Come back tomorrow to receive ${TOMORROW_COUNT}.'):('Примљено ${COUNT} тикета за пријављивање.\n'
                                                                  'Врати се сутра да примиш ${TOMORROW_COUNT}.'),
            ...
            'The tournament ended before you finished.':'Турнир се завршио пре него што си завршио игру.',
            ...
            ('WARNING: complaints of hacking have been issued against your account.\n'
             'Accounts found to be hacking will be banned.  Please play fair.'):('УПОЗОРЕЊЕ: жалбе за варање су биле издате против твог налога.\n'
            ...
            'You must update to a newer version of the app to do this.':'Мораш се надоградити на новију верзију апликације да урадиш ово.',
            'You must update to the newest version of the game to do this.':'Мораш се надоградити на најновију верзију игре да урадиш ово.',
            ...
            ('Your copy of the game has been modified.\n'
             'Please revert any changes and try again.'):('Твоја копија игре је модификована. Молимо\n'
                                                          'вас вратите било које промене и покушајте поново.'),
        ...
        'settingNames':{
            ...
            'Enable Impact Bombs':'Омогући утицајне бомбе',
        ...
        'statements':{
            ...
            'Warning to ${NAME}:  turbo / button-spamming knocks you out.':'Упозорење за ${NAME}: турбо / непрестано притискање те избацује напоље.'
        },
        'teamNames':{
            'Bad Guys':'Лоши момци',
            'Blue':'Плави',
        ...
        'tips':{
            ('A perfectly timed running-jumping-spin-punch can kill in a single hit\n'
             'and earn you lifelong respect from your friends.'):('Перфектно усклађен ударац из залета са скоком упут се вртећи може убити\n'
                                                                  'једним додиром и зарадити вам доживотно поштовање од пријатеља.'),
            ...
            'Don\'t get too cocky with that energy shield; you can still get yourself thrown off a cliff.':'Немој да се превише опустиш са штитом; и даље можеш бацити себе са литице.',
            'Don\'t run all the time.  Really.  You will fall off cliffs.':'Не трчи све време.  Озбиљно.  Пашћеш са литице.',
            ...
            ('Hold down any button to run. You\'ll get places faster\n'
             'but won\'t turn very well, so watch out for cliffs.'):('Држи било које дугме за трчање. Стићи ћеш на места брже\n'
                                                                     'али нећеш скретати баш добро, зато се пази литица.'),
            ...
            'If you kill an enemy in one hit you get double points for it.':'Ако убијеш непријатеља једним ударцом добијаш дупле поене за то.',
            ...
            ('If your device gets too warm or you\'d like to conserve battery power,\n'
             'turn down "Visuals" or "Resolution" in Settings->Graphics'):('Ако уређај постаје врућ или желиш да сачувате батерију,\n'
                                                                           'смањи "Детаље" или "Резолуција" у Подешавања->Графике'),
            ('If your framerate is choppy, try turning down resolution\n'
             'or visuals in the game\'s graphics settings.'):('Ако ти је слика нестабилна, покушај да смањиш резолуцију\n'
                                                              'или детаље у подешавањима графика у игри.'),
            ('In Capture-the-Flag, your own flag must be at your base to score, If the other\n'
             'team is about to score, stealing their flag can be a good way to stop them.'):('У "Зароби заставу", твоја властита застава мора бити у бази да би постиглао поен. Ако је\n'
            ...
            ('Many things can be picked up and thrown, including other players.  Tossing\n'
             'your enemies off cliffs can be an effective and emotionally fulfilling strategy.'):('Многе ствари могу бити подигнуте и бачене, укључујући друге играче. Шутирање\n'
                                                                                                  'непријатеља са литице може бити ефективна али и емоцијално задовољавајућа стратегија.'),
            ...
            ('The head is the most vulnerable area, so a sticky-bomb\n'
             'to the noggin usually means game-over.'):('Глава је најрањивији део, зато лепљива бомба\n'
                                                        'на глави обично значи крај игре.'),
            ...
            ('Throw strength is based on the direction you are holding.\n'
             'To toss something gently in front of you, don\'t hold any direction.'):('Снага бацање је базирана на страни коју држиш на контролеру.\n'
            ...
            'Try tricking enemies into killing eachother or running off cliffs.':'Пробај да завараш непријатеље да се међусобно убију или спадну са литице.',
            ...
            ('You can \'aim\' your punches by spinning left or right.\n'
             'This is useful for knocking bad guys off edges or scoring in hockey.'):('Можеш да "нациљаваш" ударце окретањем лево или десно.\n'
    ...
    'tutorial':{
        ...
        'phrase07Text':'Видиш? Нисмо се кретали, па је ${NAME} ово једва осетио.',
        ...
        'phrase13Text':'Упс; извини за ово ${NAME}.',
        'phrase14Text':'Можеш покупити и бацити ствари попут застава.. или ${NAME}.',
        ...
        'phrase24Text':'Оопа! Лепо испржено.',
        'phrase25Text':'Па, то је отприлике то.',
        'phrase26Text':'Сада иди и држи их, лаве!',
        'phrase27Text':'Запамти свој тренинг, и ВРАТИЋЕШ се жив!',
        'phrase28Text':'...па, можда...',
        'phrase29Text':'Срећно!',
        'randomName1Text':'Чода',
        'randomName2Text':'Ивица',
        'randomName3Text':'Били',
        'randomName4Text':'Лука',
        'randomName5Text':'Фићо',
        'skipConfirmText':'Озбиљно желиш да прескочиш туторијал? Додирни или притисни да наставиш.',
    ...
    'usingItunesText':'Коришћење iTunes за листу звукова...',
    ...
    'waveText':'Талас',
    'wellSureText':'Па наравно!',
    'wiimoteLicenseWindow':{
        'titleText':'DarwiinRemote права задржана'
    },
    'wiimoteListenWindow':{
        'listeningText':'Ослушкивање за Wiimotes...',
        'pressText':'Притисните истовремено дугмад 1 и 2 на Wiimote.',
        'pressText2':'На новијим Wiimote са уграђеним Motion Plus, притисни црвено дугме \'sync\' позади.'
    },
    'wiimoteSetupWindow':{
        'copyrightText':'DarwiinRemote права задржана.',
        'listenText':'Слушај',
        'macInstructionsText':('Буди сигуран да је твој Wii искључен и да је Bluetooth\n'
                               'омогућен на твом Mac уређају, онда притисни "Слушај".\n'
                               'Wiimote подршка може бити помало непоуздана, па ћеш можда\n'
                               'морати да покушаш неколико пута пре него што се повежеш.\n'
                               '\n'
                               'Bluetooth би требао да подржи до 7 повезаних уређаја,\n'
                               'мада може да варира.\n'
                               '\n'
                               'BombSquad подржава оригинални Wiimotеs, Nunchuks,\n'
                               'као и класичне контролере.\n'
                               'Новији \'Wii Remote Plus\' сада ради такође\n'
                               'али не са додацима.'),
        'thanksText':('Хвала DarwiinRemote тиму\n'
                      'што је ово омогућио.'),
        'titleText':'Wiimote подешавања'
    },
    ...
    'xbox360ControllersWindow':{
        ...
        'macInstructions2Text':('Да користиш контролере бежично, треба ти ресивер који долази са\n'
                                ...
                                'Један ресивер дозвољава повезивање до 4 контролера.\n'
                                '\n'
                                'Важно: ресивери треће заједнице неће радити са овим драјвером;\n'
                                'буди сигуран да ресивер каже \'Microsoft\' на њему, не \'XBOX 360\'.\n'
                                'Microsoft ово више не продаје одвојено, па ћете морати да\n'
                                'га набавите заједно са управљачем или потражите на ebay.\n'
                                '\n'
                                'Ако вам ово помогне, молимо вас размототрите донирање\n'
                                'дивелоперу драјвера на његовом сајту.'),
        'macInstructionsText':('Да користиш Xbox 360 контролере, биће ти потребно\n'
                               'да инсталираш Mac драјвер доступан на линку испод.\n'
                               'Ради и са жичаним и са бежичним управљачима.'),
        'macInstructionsTextScale':0.8,
        'ouyaInstructionsText':('Да користиш жичане Xbox 360 контролере са BombSquad, једноставно\n'
                                'их укључути у USB прикључак вашег уређаја. Можеш користити USB\n'
                                'средиште да повежеш више контролера.\n'
                                '\n'
                                'За коришћење бежичних управљача биће ти потребан бежични ресивер,\n'
                                'доступан као део "Xbox 360 Wireless Controller for Windows"\n'
                                'пакета или продат посебно. Сваки ресивер се прикључује на USB\n'
                                'прикључак и омогућава повезивање до 4 бежична управљача.'),
        'titleText':'Коришћење Xbox 360 управљача са ${APP_NAME}:'
    },
    'yesAllowText':'Да, дозволи!',
    'yourBestScoresText':'Твоји најбољи резултати',
    'yourBestTimesText':'#1037'
}