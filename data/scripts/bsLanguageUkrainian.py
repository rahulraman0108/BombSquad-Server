...
values = {
    ...
    'editSoundtrackWindow':{
        ...
        'editText':('Змінити\n'
                    'саундтрек'),
        'fetchingITunesText':'завантаження плейлистів iTunes...',
        ...
        'useITunesPlaylistText':'iTunes плейлист',
    ...
    'gatherWindow':{
        ...
        'joinPublicPartyDescriptionText':'Приєднатися до публічної групі:',
        'localNetworkDescriptionText':'Увійти в лобі у вашій мережі:',
    ...
    'internal':{
        ...
        'serverRestartingText':'ПЕРЕЗАВАНТАЖЕННЯ. Спробуй пізніше...',
    ...
    'usingItunesText':'Використання iTunes для саундтрека...',
    ...
    'yourBestScoresText':'Ваші кращі рузультати',
